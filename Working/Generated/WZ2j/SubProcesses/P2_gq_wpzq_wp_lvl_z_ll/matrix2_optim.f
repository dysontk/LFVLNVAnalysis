...
C     
C     Process: g u > w+ z d WEIGHTED<=5 @2
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: g c > w+ z s WEIGHTED<=5 @2
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: g u > w+ z d WEIGHTED<=5 @2
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL VXXXXX(P(0,1),ZERO,+1,-1*IC(1),W(1,1))  !  count 6
      CALL VXXXXX(P(0,1),ZERO,-1,-1*IC(1),W(1,2))  !  count 6
      CALL IXXXXX(P(0,2),ZERO,-1,+1*IC(2),W(1,3))  !  count 9
     ...
     $  !  count 7
      CALL FFV2_4_3(W(1,8),W(1,9),GC_50,GC_59,MDL_MZ,FK_MDL_WZ,W(1,12))  !  count 7
      CALL OXXXXX(P(0,7),ZERO,-1,+1*IC(7),W(1,13))  !  count 9
      CALL FFV1_2(W(1,3),W(1,1),GC_11,ZERO,FK_ZERO,W(1,14))  !  count 6
      CALL FFV1_2(W(1,3),W(1,2),GC_11,ZERO,FK_ZERO,W(1,15))  !  count 6
      CALL VVV1_1(W(1,6),W(1,11),GC_53,MDL_MW,FK_MDL_WW,W(1,16))  !  count 4
      CALL VVV1_1(W(1,6),W(1,12),GC_53,MDL_MW,FK_MDL_WW,W(1,17))  !  count 4
      CALL FFV2P1N_1(W(1,13), W(1,16), GC_100, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/14,15/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,13), W(1,17), GC_100, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/14,15/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_1(W(1,13),W(1,6),GC_100,ZERO,FK_ZERO,W(1,18))  !  count 8
      CALL FFV2_5P1N_1(W(1,18), W(1,11), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/14,15/),
     & TMP, W, AMP(1,2))
      CALL FFV2_5P1N_1(W(1,18), W(1,12), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/14,15/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_3_1(W(1,13),W(1,11),GC_50,GC_58,ZERO,FK_ZERO,W(1,19))  !  count 4
      CALL FFV2_3_1(W(1,13),W(1,12),GC_50,GC_58,ZERO,FK_ZERO,W(1,20))  !  count 4
      CALL FFV2P1N_1(W(1,19), W(1,6), GC_100, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/14,15/),
     & TMP, W, AMP(1,3))
      CALL FFV2P1N_1(W(1,20), W(1,6), GC_100, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/14,15/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV1_1(W(1,13),W(1,1),GC_11,ZERO,FK_ZERO,W(1,21))  !  count 6
      CALL FFV1_1(W(1,13),W(1,2),GC_11,ZERO,FK_ZERO,W(1,22))  !  count 6
      CALL FFV2_2(W(1,3),W(1,6),GC_100,ZERO,FK_ZERO,W(1,23))  !  count 8
      CALL FFV2_3P1N_2(W(1,23), W(1,11), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/21,22/),
     & TMP, W, AMP(1,4))
      CALL FFV2_3P1N_2(W(1,23), W(1,12), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/21,22/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_5_2(W(1,3),W(1,11),-GC_50,GC_58,ZERO,FK_ZERO,W(1,24))  !  count 4
      CALL FFV2_5_2(W(1,3),W(1,12),-GC_50,GC_58,ZERO,FK_ZERO,W(1,25))  !  count 4
      CALL FFV2P1N_1(W(1,21), W(1,6), GC_100, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/24,25/),
     & TMP, W, AMP(1,5))
      CALL FFV2P1N_1(W(1,22), W(1,6), GC_100, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/24,25/),
     & TMP, W, AMP(1,5))  !  count 1
      CALL FFV2P1N_2(W(1,3), W(1,16), GC_100, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/21,22/),
     & TMP, W, AMP(1,6))
      CALL FFV2P1N_2(W(1,3), W(1,17), GC_100, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/21,22/),
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV1P1N_2(W(1,23), W(1,1), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/19,20/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_2(W(1,23), W(1,2), GC_11, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/19,20/),
     & TMP, W, AMP(1,7))  !  count 1
      CALL FFV1P1N_1(W(1,18), W(1,1), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/24,25/),
     & TMP, W, AMP(1,8))
      CALL FFV1P1N_1(W(1,18), W(1,2), GC_11, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/24,25/),
