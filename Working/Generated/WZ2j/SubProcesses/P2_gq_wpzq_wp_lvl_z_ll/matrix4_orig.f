...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL VVV1_1(W(1,5),W(1,6),GC_53,MDL_MW, FK_MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,4),W(1,2),W(1,7),GC_100,AMP(1))
      CALL FFV2_1(W(1,2),W(1,5),GC_100,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV2_5_0(W(1,4),W(1,8),W(1,6),-GC_50,GC_58,AMP(2))
      CALL FFV2_3_1(W(1,2),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,4),W(1,9),W(1,5),GC_100,AMP(3))
      CALL FFV1_1(W(1,2),W(1,1),GC_11,ZERO, FK_ZERO,W(1,4))
      CALL FFV2_2(W(1,3),W(1,5),GC_100,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,2),W(1,4),W(1,6),GC_50,GC_58,AMP(4))
      CALL FFV2_5_2(W(1,3),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,10),W(1,4),W(1,5),GC_100,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,3),W(1,4),W(1,7),GC_100,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,2),W(1,9),W(1,1),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,10),W(1,8),W(1,1),GC_11,AMP(8))
