...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV1_1(W(1,3),W(1,7),GC_11,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,4),W(1,9),W(1,8),GC_100,AMP(1))
      CALL FFV1_2(W(1,4),W(1,7),GC_11,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,10),W(1,3),W(1,8),GC_100,AMP(2))
      CALL FFV2_1(W(1,3),W(1,5),GC_100,ZERO, FK_ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV2_3_1(W(1,3),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1_1(W(1,3),W(1,1),GC_11,ZERO, FK_ZERO,W(1,9))
      CALL FFV1_2(W(1,4),W(1,2),GC_11,ZERO, FK_ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 19
      ...
      CALL FFV1_2(W(1,7),W(1,2),GC_11,ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 20
      CALL FFV2_0(W(1,17),W(1,3),W(1,8),GC_100,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV2_5_0(W(1,17),W(1,11),W(1,6),-GC_50,GC_58,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,9),W(1,11),W(1,2),GC_11,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_0(W(1,17),W(1,14),W(1,5),GC_100,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,15),W(1,14),W(1,2),GC_11,AMP(24))
...
C     Amplitude(s) for diagram number 30
      CALL FFV2_0(W(1,16),W(1,3),W(1,8),GC_100,AMP(30))
...
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,12),W(1,8),W(1,2),GC_11,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL FFV1_0(W(1,15),W(1,11),W(1,2),GC_11,AMP(36))
C     Amplitude(s) for diagram number 37
      CALL FFV1_0(W(1,4),W(1,14),W(1,2),GC_11,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,13),W(1,16),W(1,2),GC_11,AMP(38))
