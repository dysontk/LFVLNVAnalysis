...
C     
C     Process: u c > w+ z u s WEIGHTED<=6 @4
...
C     ----------
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_3_1(W(1,15),W(1,11),GC_50,GC_58,ZERO,FK_ZERO,W(1,30))  !  count 4
      CALL FFV2_3_1(W(1,15),W(1,12),GC_50,GC_58,ZERO,FK_ZERO,W(1,31))  !  count 4
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_5_2(W(1,3),W(1,11),-GC_50,GC_58,ZERO,FK_ZERO,W(1,32))  !  count 4
      CALL FFV2_5_2(W(1,3),W(1,12),-GC_50,GC_58,ZERO,FK_ZERO,W(1,33))  !  count 4
