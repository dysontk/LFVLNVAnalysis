...
C     
C     Process: u c~ > w+ z d c~ WEIGHTED<=6 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: c u~ > w+ z s u~ WEIGHTED<=6 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: u c~ > w+ z d c~ WEIGHTED<=6 @4
...
C     ----------
     ...
     $  !  count 10
      ...
      CALL FFV2_5_2(W(1,14),W(1,11),-GC_50,GC_58,ZERO,FK_ZERO,W(1,17))  !  count 2
      CALL FFV2_5_2(W(1,14),W(1,12),-GC_50,GC_58,ZERO,FK_ZERO,W(1,18))  !  count 2
      CALL FFV2_5_2(W(1,15),W(1,11),-GC_50,GC_58,ZERO,FK_ZERO,W(1,19))  !  count 2
      CALL FFV2_5_2(W(1,15),W(1,12),-GC_50,GC_58,ZERO,FK_ZERO,W(1,20))  !  count 2
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_5_1(W(1,2),W(1,11),-GC_50,GC_58,ZERO,FK_ZERO,W(1,28))  !  count 2
      CALL FFV2_5_1(W(1,2),W(1,12),-GC_50,GC_58,ZERO,FK_ZERO,W(1,29))  !  count 2
      CALL FFV2_5_1(W(1,3),W(1,11),-GC_50,GC_58,ZERO,FK_ZERO,W(1,30))  !  count 2
      CALL FFV2_5_1(W(1,3),W(1,12),-GC_50,GC_58,ZERO,FK_ZERO,W(1,31))  !  count 2
