            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 43 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX43(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.5.3, 2023-12-23
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_43(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_43/ZEROAMP_43
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_3_1(W(1,1),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1P0_3(W(1,3),W(1,12),GC_11,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,8),W(1,1),W(1,9),GC_11,AMP(7))
      CALL VVV1_1(W(1,5),W(1,6),GC_53,MDL_MW, FK_MDL_WW,W(1,8))
      CALL FFV1_2(W(1,3),W(1,10),GC_11,ZERO, FK_ZERO,W(1,1))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,1),W(1,2),W(1,8),GC_100,AMP(8))
      CALL FFV2_2(W(1,3),W(1,8),GC_100,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,13),W(1,2),W(1,10),GC_11,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV2_5_0(W(1,1),W(1,12),W(1,6),-GC_50,GC_58,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,1),W(1,11),W(1,5),GC_100,AMP(11))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX43 = MATRIX43 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_43(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 43, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_43(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 43, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
