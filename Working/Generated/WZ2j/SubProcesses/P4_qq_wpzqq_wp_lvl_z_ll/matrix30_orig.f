...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_2(W(1,4),W(1,5),GC_100,ZERO, FK_ZERO,W(1,7))
      CALL FFV2_3_2(W(1,1),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1P0_3(W(1,1),W(1,2),GC_11,ZERO, FK_ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV1P0_3(W(1,1),W(1,3),GC_11,ZERO, FK_ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,1),W(1,12),W(1,10),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,1),W(1,13),W(1,9),GC_11,AMP(8))
      CALL FFV2_5_2(W(1,4),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV1P0_3(W(1,4),W(1,10),GC_11,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,8),W(1,3),W(1,9),GC_11,AMP(13))
      CALL FFV1P0_3(W(1,4),W(1,7),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,8),W(1,2),W(1,15),GC_11,AMP(14))
      CALL VVV1_1(W(1,5),W(1,6),GC_53,MDL_MW, FK_MDL_WW,W(1,8))
      CALL FFV1_2(W(1,4),W(1,11),GC_11,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,16),W(1,3),W(1,8),GC_100,AMP(15))
      CALL FFV2_2(W(1,4),W(1,8),GC_100,ZERO, FK_ZERO,W(1,17))
...
C     Amplitude(s) for diagram number 18
      ...
      CALL FFV1_2(W(1,4),W(1,14),GC_11,ZERO, FK_ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,1),W(1,13),W(1,9),GC_11,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,1),W(1,12),W(1,15),GC_11,AMP(24))
