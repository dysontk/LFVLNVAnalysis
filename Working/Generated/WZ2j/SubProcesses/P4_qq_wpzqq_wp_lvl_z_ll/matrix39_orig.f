            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 39 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX39(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.5.3, 2023-12-23
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_39(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_39/ZEROAMP_39
...
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,10),W(1,2),W(1,11),GC_11,AMP(9))
      CALL FFV2_1(W(1,2),W(1,5),GC_100,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,9),W(1,7),W(1,11),GC_11,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,10),W(1,1),W(1,14),GC_11,AMP(11))
      CALL FFV2_1(W(1,1),W(1,5),GC_100,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,9),W(1,10),W(1,14),GC_11,AMP(12))
      CALL FFV1P0_3(W(1,3),W(1,10),GC_11,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,8),W(1,2),W(1,9),GC_11,AMP(13))
      CALL FFV1P0_3(W(1,3),W(1,7),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,8),W(1,1),W(1,15),GC_11,AMP(14))
      CALL VVV1_1(W(1,5),W(1,6),GC_53,MDL_MW, FK_MDL_WW,W(1,8))
      CALL FFV1_2(W(1,3),W(1,11),GC_11,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,16),W(1,2),W(1,8),GC_100,AMP(15))
      CALL FFV2_2(W(1,3),W(1,8),GC_100,ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,17),W(1,2),W(1,11),GC_11,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV2_5_0(W(1,16),W(1,7),W(1,6),-GC_50,GC_58,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV2_0(W(1,16),W(1,13),W(1,5),GC_100,AMP(18))
      CALL FFV1_2(W(1,3),W(1,14),GC_11,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 19
      CALL FFV2_0(W(1,16),W(1,1),W(1,8),GC_100,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,17),W(1,1),W(1,14),GC_11,AMP(20))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -1.666666666666667D-01)*TMP_JAMP(22)
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX39 = MATRIX39 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_39(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 39, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_39(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 39, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
