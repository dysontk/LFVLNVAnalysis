            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 35 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX35(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.5.3, 2023-12-23
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_35(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_35/ZEROAMP_35
...
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,8),W(1,1),W(1,9),GC_11,AMP(1))
      CALL FFV1P0_3(W(1,4),W(1,1),GC_11,ZERO, FK_ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_5_1(W(1,1),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV1P0_3(W(1,9),W(1,1),GC_11,ZERO, FK_ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1P0_3(W(1,3),W(1,1),GC_11,ZERO, FK_ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,8),W(1,1),W(1,12),GC_11,AMP(18))
      CALL FFV1_2(W(1,3),W(1,10),GC_11,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 19
      CALL FFV2_0(W(1,8),W(1,2),W(1,15),GC_100,AMP(19))
      CALL FFV2_2(W(1,3),W(1,15),GC_100,ZERO, FK_ZERO,W(1,1))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,1),W(1,2),W(1,10),GC_11,AMP(20))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -1.666666666666667D-01)*TMP_JAMP(22)
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX35 = MATRIX35 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_35(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 35, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_35(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 35, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
