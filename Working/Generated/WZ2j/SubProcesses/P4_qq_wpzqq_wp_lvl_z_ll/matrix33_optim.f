...
C     
C     Process: d s~ > w+ z d c~ WEIGHTED<=6 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     Process: s d~ > w+ z s u~ WEIGHTED<=6 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     Process: d s~ > w+ z d c~ WEIGHTED<=6 @4
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),ZERO,+1,+1*IC(1),W(1,1))  !  count 7
      CALL IXXXXX(P(0,1),ZERO,-1,+1*IC(1),W(1,2))  !  count 7
      CALL OXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,3))  !  count 20
      CALL IXXXXX(P(0,3),ZERO,+1,-1*IC(3),W(1,4))  !  count 1
      CALL OXXXXX(P(0,4),ZERO,-1,+1*IC(4),W(1,5))  !  count 1
      CALL FFV2_3(W(1,4),W(1,5),GC_100,MDL_MW,FK_MDL_WW,W(1,6))  !  count 10
     ...
     $  !  count 10
      CALL FFV2_4_3(W(1,8),W(1,9),GC_50,GC_59,MDL_MZ,FK_MDL_WZ,W(1,12))  !  count 10
      CALL OXXXXX(P(0,7),ZERO,+1,+1*IC(7),W(1,13))  !  count 7
      CALL OXXXXX(P(0,7),ZERO,-1,+1*IC(7),W(1,14))  !  count 7
      CALL IXXXXX(P(0,8),ZERO,+1,-1*IC(8),W(1,15))  !  count 8
      CALL FFV2_2(W(1,15),W(1,6),GC_100,ZERO,FK_ZERO,W(1,16))  !  count 7
      CALL FFV2_3_2(W(1,1),W(1,11),GC_50,GC_58,ZERO,FK_ZERO,W(1,17))  !  count 2
      CALL FFV2_3_2(W(1,1),W(1,12),GC_50,GC_58,ZERO,FK_ZERO,W(1,18))  !  count 2
      CALL FFV2_3_2(W(1,2),W(1,11),GC_50,GC_58,ZERO,FK_ZERO,W(1,19))  !  count 2
      CALL FFV2_3_2(W(1,2),W(1,12),GC_50,GC_58,ZERO,FK_ZERO,W(1,20))  !  count 2
      CALL FFV1P0_3(W(1,16),W(1,3),GC_11,ZERO,FK_ZERO,W(1,21))  !  count 8
      CALL FFV1P1N_1(W(1,13), W(1,21), GC_11, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/17,18/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,14), W(1,21), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/19,20/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,13),GC_11,ZERO,FK_ZERO,W(1,22))  !  count 11
      CALL FFV1P0_3(W(1,2),W(1,14),GC_11,ZERO,FK_ZERO,W(1,23))  !  count 11
      CALL FFV2_3_2(W(1,16),W(1,11),GC_50,GC_58,ZERO,FK_ZERO,W(1,24))  !  count 2
      CALL FFV2_3_2(W(1,16),W(1,12),GC_50,GC_58,ZERO,FK_ZERO,W(1,25))  !  count 2
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_3_1(W(1,3),W(1,11),GC_50,GC_58,ZERO,FK_ZERO,W(1,26))  !  count 4
      CALL FFV2_3_1(W(1,3),W(1,12),GC_50,GC_58,ZERO,FK_ZERO,W(1,27))  !  count 4
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_3_1(W(1,13),W(1,11),GC_50,GC_58,ZERO,FK_ZERO,W(1,28))  !  count 2
      CALL FFV2_3_1(W(1,13),W(1,12),GC_50,GC_58,ZERO,FK_ZERO,W(1,29))  !  count 2
      CALL FFV2_3_1(W(1,14),W(1,11),GC_50,GC_58,ZERO,FK_ZERO,W(1,30))  !  count 2
      CALL FFV2_3_1(W(1,14),W(1,12),GC_50,GC_58,ZERO,FK_ZERO,W(1,31))  !  count 2
      CALL FFV1P1N_2(W(1,1), W(1,21), GC_11, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/28,29/),
     & TMP, W, AMP(1,4))
      CALL FFV1P1N_2(W(1,2), W(1,21), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/30,31/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_5_2(W(1,15),W(1,11),-GC_50,GC_58,ZERO,FK_ZERO,W(1,32))  !  count 3
      CALL FFV2_5_2(W(1,15),W(1,12),-GC_50,GC_58,ZERO,FK_ZERO,W(1,33))  !  count 3
      CALL FFV2_2(W(1,32),W(1,6),GC_100,ZERO,FK_ZERO,W(1,34))  !  count 2
      CALL FFV2_2(W(1,33),W(1,6),GC_100,ZERO,FK_ZERO,W(1,35))  !  count 2
      CALL FFV1P1N_1(W(1,3), W(1,22), GC_11, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/34,35/),
     ...
     & TMP, W, AMP(1,5))  !  count 1
      CALL FFV2_1(W(1,3),W(1,6),GC_100,ZERO,FK_ZERO,W(1,36))  !  count 9
     ...
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV1P0_3(W(1,15),W(1,36),GC_11,ZERO,FK_ZERO,W(1,37))  !  count 8
      CALL FFV1P1N_1(W(1,13), W(1,37), GC_11, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/17,18/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,14), W(1,37), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/19,20/),
     & TMP, W, AMP(1,7))  !  count 1
      CALL VVV1_1(W(1,6),W(1,11),GC_53,MDL_MW,FK_MDL_WW,W(1,38))  !  count 3
      CALL VVV1_1(W(1,6),W(1,12),GC_53,MDL_MW,FK_MDL_WW,W(1,39))  !  count 3
      CALL FFV1_2(W(1,15),W(1,22),GC_11,ZERO,FK_ZERO,W(1,40))  !  count 6
      CALL FFV1_2(W(1,15),W(1,23),GC_11,ZERO,FK_ZERO,W(1,41))  !  count 6
      CALL FFV2P1N_1(W(1,3), W(1,38), GC_100, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/40,41/),
     & TMP, W, AMP(1,8))
      CALL FFV2P1N_1(W(1,3), W(1,39), GC_100, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/40,41/),
     & TMP, W, AMP(1,8))  !  count 1
      CALL FFV2_2(W(1,15),W(1,38),GC_100,ZERO,FK_ZERO,W(1,42))  !  count 2
      CALL FFV2_2(W(1,15),W(1,39),GC_100,ZERO,FK_ZERO,W(1,43))  !  count 2
      CALL FFV1P1N_1(W(1,3), W(1,22), GC_11, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/42,43/),
     ...
     & TMP, W, AMP(1,9))  !  count 1
      CALL FFV2_5P1N_1(W(1,36), W(1,11), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/40,41/),
     & TMP, W, AMP(1,10))
      CALL FFV2_5P1N_1(W(1,36), W(1,12), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/40,41/),
     & TMP, W, AMP(1,10))  !  count 1
      CALL FFV2P1N_1(W(1,26), W(1,6), GC_100, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/40,41/),
     & TMP, W, AMP(1,11))
      CALL FFV2P1N_1(W(1,27), W(1,6), GC_100, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/40,41/),
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX33(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS33/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS33
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX33=SOINDEX_FOR_SQUARED_ORDERS33(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS33(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS33/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS33 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function' 
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS33'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN33(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX33(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX33'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX33(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS33(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS33 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS33'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
