...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1P0_3(W(1,2),W(1,3),GC_11,ZERO, FK_ZERO,W(1,10))
      CALL FFV2_3_2(W(1,7),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,11),W(1,4),W(1,10),GC_11,AMP(2))
      CALL FFV2_3_1(W(1,4),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,14),W(1,4),W(1,10),GC_11,AMP(6))
      CALL FFV2_1(W(1,4),W(1,5),GC_100,ZERO, FK_ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1_1(W(1,4),W(1,13),GC_11,ZERO, FK_ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 13
      CALL FFV2_0(W(1,16),W(1,4),W(1,15),GC_100,AMP(13))
...
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,12),W(1,4),W(1,16),GC_11,AMP(17))
...
C     Amplitude(s) for diagram number 19
      CALL FFV2_0(W(1,8),W(1,4),W(1,15),GC_100,AMP(19))
      CALL FFV2_2(W(1,1),W(1,15),GC_100,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,3),W(1,4),W(1,10),GC_11,AMP(20))
