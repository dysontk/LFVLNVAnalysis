...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV2_2(W(1,9),W(1,5),GC_100,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,10),W(1,3),W(1,11),GC_11,AMP(9))
      CALL FFV2_1(W(1,3),W(1,5),GC_100,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,9),W(1,7),W(1,11),GC_11,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,10),W(1,2),W(1,14),GC_11,AMP(11))
      CALL FFV2_1(W(1,2),W(1,5),GC_100,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,9),W(1,10),W(1,14),GC_11,AMP(12))
      CALL FFV1P0_3(W(1,1),W(1,10),GC_11,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,8),W(1,3),W(1,9),GC_11,AMP(13))
      CALL FFV1P0_3(W(1,1),W(1,7),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,8),W(1,2),W(1,15),GC_11,AMP(14))
      CALL VVV1_1(W(1,5),W(1,6),GC_53,MDL_MW, FK_MDL_WW,W(1,8))
      CALL FFV1_2(W(1,1),W(1,11),GC_11,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,16),W(1,3),W(1,8),GC_100,AMP(15))
      CALL FFV2_2(W(1,1),W(1,8),GC_100,ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,17),W(1,3),W(1,11),GC_11,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV2_5_0(W(1,16),W(1,7),W(1,6),-GC_50,GC_58,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV2_0(W(1,16),W(1,13),W(1,5),GC_100,AMP(18))
      CALL FFV1_2(W(1,1),W(1,14),GC_11,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 19
      CALL FFV2_0(W(1,16),W(1,2),W(1,8),GC_100,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,17),W(1,2),W(1,14),GC_11,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV2_5_0(W(1,16),W(1,10),W(1,6),-GC_50,GC_58,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV2_0(W(1,16),W(1,12),W(1,5),GC_100,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,4),W(1,13),W(1,9),GC_11,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,4),W(1,12),W(1,15),GC_11,AMP(24))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      TMP_JAMP(12) = AMP(22) +  AMP(23)  ! used 2 times
      TMP_JAMP(11) = AMP(20) +  AMP(21)  ! used 2 times
      TMP_JAMP(10) = AMP(18) +  AMP(24)  ! used 2 times
      TMP_JAMP(9) = AMP(16) +  AMP(17)  ! used 2 times
      TMP_JAMP(8) = AMP(14) +  AMP(15)  ! used 2 times
      TMP_JAMP(7) = AMP(13) +  AMP(19)  ! used 2 times
