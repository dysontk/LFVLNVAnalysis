...
C     
C     Process: u s~ > w+ z d s~ WEIGHTED<=6 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: c d~ > w+ z s d~ WEIGHTED<=6 @4
C     *   Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: u s~ > w+ z d s~ WEIGHTED<=6 @4
...
C     ----------
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_3_1(W(1,13),W(1,11),GC_50,GC_58,ZERO,FK_ZERO,W(1,26))  !  count 4
      CALL FFV2_3_1(W(1,13),W(1,12),GC_50,GC_58,ZERO,FK_ZERO,W(1,27))  !  count 4
