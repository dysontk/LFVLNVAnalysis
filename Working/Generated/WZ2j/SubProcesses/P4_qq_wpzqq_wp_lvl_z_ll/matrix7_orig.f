...
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,10),W(1,4),W(1,11),GC_11,AMP(9))
      CALL FFV2_1(W(1,4),W(1,5),GC_100,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,9),W(1,7),W(1,11),GC_11,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,10),W(1,3),W(1,14),GC_11,AMP(11))
...
C     Amplitude(s) for diagram number 19
      CALL FFV2_0(W(1,16),W(1,3),W(1,8),GC_100,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,17),W(1,3),W(1,14),GC_11,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV2_5_0(W(1,16),W(1,10),W(1,6),-GC_50,GC_58,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV2_0(W(1,16),W(1,12),W(1,5),GC_100,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,2),W(1,13),W(1,9),GC_11,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,2),W(1,12),W(1,15),GC_11,AMP(24))
