...
C     
C     Process: d u~ > w- z g WEIGHTED<=5 @1
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: s c~ > w- z g WEIGHTED<=5 @1
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: d u~ > w- z g WEIGHTED<=5 @1
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL VVV1_2(W(1,5),W(1,10),GC_53,MDL_MW,FK_MDL_WW,W(1,16))  !  count 4
      CALL VVV1_2(W(1,5),W(1,11),GC_53,MDL_MW,FK_MDL_WW,W(1,17))  !  count 4
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV2_3P1N_1(W(1,18), W(1,10), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/14,15/),
     & TMP, W, AMP(1,2))
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_5_1(W(1,2),W(1,10),-GC_50,GC_58,ZERO,FK_ZERO,W(1,19))  !  count 4
      CALL FFV2_5_1(W(1,2),W(1,11),-GC_50,GC_58,ZERO,FK_ZERO,W(1,20))  !  count 4
     ...
     & TMP, W, AMP(1,3))  !  count 1
      ...
      CALL FFV2_5P1N_2(W(1,23), W(1,10), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/21,22/),
     & TMP, W, AMP(1,4))
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_3_2(W(1,1),W(1,10),GC_50,GC_58,ZERO,FK_ZERO,W(1,24))  !  count 4
      CALL FFV2_3_2(W(1,1),W(1,11),GC_50,GC_58,ZERO,FK_ZERO,W(1,25))  !  count 4
