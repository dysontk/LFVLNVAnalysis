...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_2(W(1,1),W(1,5),GC_100,ZERO, FK_ZERO,W(1,2))
...
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,1),W(1,4),W(1,7),GC_100,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,2),W(1,9),W(1,3),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,10),W(1,8),W(1,3),GC_11,AMP(8))
