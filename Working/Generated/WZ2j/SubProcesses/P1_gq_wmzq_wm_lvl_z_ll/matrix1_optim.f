...
C     
C     Process: g d > w- z u WEIGHTED<=5 @1
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     Process: g s > w- z c WEIGHTED<=5 @1
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     Process: g d > w- z u WEIGHTED<=5 @1
...
C     ----------
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_5_1(W(1,13),W(1,11),-GC_50,GC_58,ZERO,FK_ZERO,W(1,19))  !  count 4
      CALL FFV2_5_1(W(1,13),W(1,12),-GC_50,GC_58,ZERO,FK_ZERO,W(1,20))  !  count 4
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_3_2(W(1,3),W(1,11),GC_50,GC_58,ZERO,FK_ZERO,W(1,24))  !  count 4
      CALL FFV2_3_2(W(1,3),W(1,12),GC_50,GC_58,ZERO,FK_ZERO,W(1,25))  !  count 4
