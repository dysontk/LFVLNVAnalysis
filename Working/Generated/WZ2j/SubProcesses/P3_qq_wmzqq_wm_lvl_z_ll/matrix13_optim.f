...
C     
C     Process: d s > w- z u s WEIGHTED<=6 @3
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL IXXXXX(P(0,2),ZERO,+1,+1*IC(2),W(1,2))  !  count 7
      CALL IXXXXX(P(0,2),ZERO,-1,+1*IC(2),W(1,3))  !  count 7
     ...
     $  !  count 10
      ...
      CALL OXXXXX(P(0,7),ZERO,-1,+1*IC(7),W(1,13))  !  count 20
      CALL OXXXXX(P(0,8),ZERO,+1,+1*IC(8),W(1,14))  !  count 7
      CALL OXXXXX(P(0,8),ZERO,-1,+1*IC(8),W(1,15))  !  count 7
      CALL FFV2_2(W(1,1),W(1,6),GC_100,ZERO,FK_ZERO,W(1,16))  !  count 7
      CALL FFV2_3_2(W(1,2),W(1,11),GC_50,GC_58,ZERO,FK_ZERO,W(1,17))  !  count 2
      CALL FFV2_3_2(W(1,2),W(1,12),GC_50,GC_58,ZERO,FK_ZERO,W(1,18))  !  count 2
      CALL FFV2_3_2(W(1,3),W(1,11),GC_50,GC_58,ZERO,FK_ZERO,W(1,19))  !  count 2
      CALL FFV2_3_2(W(1,3),W(1,12),GC_50,GC_58,ZERO,FK_ZERO,W(1,20))  !  count 2
      CALL FFV1P0_3(W(1,16),W(1,13),GC_11,ZERO,FK_ZERO,W(1,21))  !  count 8
      CALL FFV1P1N_1(W(1,14), W(1,21), GC_11, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/17,18/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,15), W(1,21), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/19,20/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1P0_3(W(1,2),W(1,14),GC_11,ZERO,FK_ZERO,W(1,22))  !  count 11
      CALL FFV1P0_3(W(1,3),W(1,15),GC_11,ZERO,FK_ZERO,W(1,23))  !  count 11
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_5_1(W(1,13),W(1,11),-GC_50,GC_58,ZERO,FK_ZERO,W(1,26))  !  count 4
      CALL FFV2_5_1(W(1,13),W(1,12),-GC_50,GC_58,ZERO,FK_ZERO,W(1,27))  !  count 4
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_3_1(W(1,14),W(1,11),GC_50,GC_58,ZERO,FK_ZERO,W(1,28))  !  count 2
      CALL FFV2_3_1(W(1,14),W(1,12),GC_50,GC_58,ZERO,FK_ZERO,W(1,29))  !  count 2
      CALL FFV2_3_1(W(1,15),W(1,11),GC_50,GC_58,ZERO,FK_ZERO,W(1,30))  !  count 2
      CALL FFV2_3_1(W(1,15),W(1,12),GC_50,GC_58,ZERO,FK_ZERO,W(1,31))  !  count 2
      CALL FFV1P1N_2(W(1,2), W(1,21), GC_11, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/28,29/),
     & TMP, W, AMP(1,4))
      CALL FFV1P1N_2(W(1,3), W(1,21), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/30,31/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_3_2(W(1,1),W(1,11),GC_50,GC_58,ZERO,FK_ZERO,W(1,32))  !  count 3
      CALL FFV2_3_2(W(1,1),W(1,12),GC_50,GC_58,ZERO,FK_ZERO,W(1,33))  !  count 3
     ...
     & TMP, W, AMP(1,5))  !  count 1
      CALL FFV2_1(W(1,13),W(1,6),GC_100,ZERO,FK_ZERO,W(1,36))  !  count 9
     ...
     & (/17,18/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,15), W(1,37), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/19,20/),
     & TMP, W, AMP(1,7))  !  count 1
      ...
      CALL FFV2P1N_1(W(1,13), W(1,38), GC_100, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/40,41/),
     & TMP, W, AMP(1,8))
      CALL FFV2P1N_1(W(1,13), W(1,39), GC_100, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/40,41/),
     ...
     & (/28,29/),
     & TMP, W, AMP(1,12))
      CALL FFV1P1N_2(W(1,3), W(1,37), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/30,31/),
