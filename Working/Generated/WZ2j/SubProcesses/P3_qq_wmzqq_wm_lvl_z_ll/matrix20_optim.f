...
C     
C     Process: d u~ > w- z c c~ WEIGHTED<=6 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: s c~ > w- z u u~ WEIGHTED<=6 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: d u~ > w- z c c~ WEIGHTED<=6 @3
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL OXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,2))  !  count 17
      CALL OXXXXX(P(0,3),ZERO,-1,+1*IC(3),W(1,3))  !  count 1
      CALL IXXXXX(P(0,4),ZERO,+1,-1*IC(4),W(1,4))  !  count 1
      CALL FFV2_3(W(1,4),W(1,3),GC_100,MDL_MW,FK_MDL_WW,W(1,5))  !  count 12
      ...
      CALL FFV2_4_3(W(1,6),W(1,9),GC_50,GC_59,MDL_MZ,FK_MDL_WZ,W(1,10))  !  count 11
      CALL FFV2_4_3(W(1,7),W(1,8),GC_50,GC_59,MDL_MZ,FK_MDL_WZ,W(1,11))  !  count 11
      CALL OXXXXX(P(0,7),ZERO,+1,+1*IC(7),W(1,12))  !  count 5
      ...
      CALL FFV2_5_2(W(1,14),W(1,10),-GC_50,GC_58,ZERO,FK_ZERO,W(1,16))  !  count 1
      CALL FFV2_5_2(W(1,14),W(1,11),-GC_50,GC_58,ZERO,FK_ZERO,W(1,17))  !  count 1
      CALL FFV2_5_2(W(1,15),W(1,10),-GC_50,GC_58,ZERO,FK_ZERO,W(1,18))  !  count 1
      CALL FFV2_5_2(W(1,15),W(1,11),-GC_50,GC_58,ZERO,FK_ZERO,W(1,19))  !  count 1
      CALL FFV2_2(W(1,1),W(1,5),GC_100,ZERO,FK_ZERO,W(1,20))  !  count 16
      ...
      CALL FFV1P0_3(W(1,18),W(1,12),GC_11,ZERO,FK_ZERO,W(1,23))  !  count 2
      CALL FFV1P0_3(W(1,19),W(1,12),GC_11,ZERO,FK_ZERO,W(1,24))  !  count 2
      CALL FFV1P1N_3(W(1,20), W(1,2), GC_11, TMP(1))
      call CombineAmp(4,
     & (/1,3,2,4/), 
     & (/21,22,23,24/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_1(W(1,2),W(1,5),GC_100,ZERO,FK_ZERO,W(1,25))  !  count 16
      CALL FFV1P1N_3(W(1,1), W(1,25), GC_11, TMP(1))
      call CombineAmp(4,
     & (/1,3,2,4/), 
     & (/21,22,23,24/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1P0_3(W(1,14),W(1,13),GC_11,ZERO,FK_ZERO,W(1,26))  !  count 6
      CALL FFV1P0_3(W(1,15),W(1,12),GC_11,ZERO,FK_ZERO,W(1,27))  !  count 6
      CALL FFV1_1(W(1,2),W(1,26),GC_11,ZERO,FK_ZERO,W(1,28))  !  count 6
      CALL FFV1_1(W(1,2),W(1,27),GC_11,ZERO,FK_ZERO,W(1,29))  !  count 6
      CALL FFV2_5P1N_2(W(1,20), W(1,10), -GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/28,29/),
     & TMP, W, AMP(1,3))
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_5_1(W(1,2),W(1,10),-GC_50,GC_58,ZERO,FK_ZERO,W(1,30))  !  count 4
      CALL FFV2_5_1(W(1,2),W(1,11),-GC_50,GC_58,ZERO,FK_ZERO,W(1,31))  !  count 4
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_3_2(W(1,1),W(1,10),GC_50,GC_58,ZERO,FK_ZERO,W(1,32))  !  count 4
      CALL FFV2_3_2(W(1,1),W(1,11),GC_50,GC_58,ZERO,FK_ZERO,W(1,33))  !  count 4
      CALL FFV2P1N_1(W(1,28), W(1,5), GC_100, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/32,33/),
     & TMP, W, AMP(1,5))
      CALL FFV2P1N_1(W(1,29), W(1,5), GC_100, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/32,33/),
     ...
     & TMP, W, AMP(1,6))  !  count 1
      CALL VVV1_2(W(1,5),W(1,10),GC_53,MDL_MW,FK_MDL_WW,W(1,34))  !  count 4
      CALL VVV1_2(W(1,5),W(1,11),GC_53,MDL_MW,FK_MDL_WW,W(1,35))  !  count 4
      CALL FFV1_2(W(1,1),W(1,26),GC_11,ZERO,FK_ZERO,W(1,36))  !  count 6
      CALL FFV1_2(W(1,1),W(1,27),GC_11,ZERO,FK_ZERO,W(1,37))  !  count 6
      CALL FFV2P1N_1(W(1,2), W(1,34), GC_100, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/36,37/),
     & TMP, W, AMP(1,7))
      CALL FFV2P1N_1(W(1,2), W(1,35), GC_100, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/36,37/),
     ...
     & TMP, W, AMP(1,8))  !  count 1
      CALL FFV2_3P1N_1(W(1,25), W(1,10), GC_50, GC_58, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/36,37/),
     & TMP, W, AMP(1,9))
     ...
     & TMP, W, AMP(1,9))  !  count 1
      CALL FFV2P1N_1(W(1,30), W(1,5), GC_100, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/36,37/),
     & TMP, W, AMP(1,10))
      CALL FFV2P1N_1(W(1,31), W(1,5), GC_100, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/36,37/),
     & TMP, W, AMP(1,10))  !  count 1
      CALL FFV2_5_1(W(1,12),W(1,10),-GC_50,GC_58,ZERO,FK_ZERO,W(1,38))  !  count 1
      CALL FFV2_5_1(W(1,12),W(1,11),-GC_50,GC_58,ZERO,FK_ZERO,W(1,39))  !  count 1
      CALL FFV2_5_1(W(1,13),W(1,10),-GC_50,GC_58,ZERO,FK_ZERO,W(1,40))  !  count 1
      CALL FFV2_5_1(W(1,13),W(1,11),-GC_50,GC_58,ZERO,FK_ZERO,W(1,41))  !  count 1
      CALL FFV1P0_3(W(1,14),W(1,40),GC_11,ZERO,FK_ZERO,W(1,42))  !  count 2
      CALL FFV1P0_3(W(1,14),W(1,41),GC_11,ZERO,FK_ZERO,W(1,43))  !  count 2
      CALL FFV1P0_3(W(1,15),W(1,38),GC_11,ZERO,FK_ZERO,W(1,44))  !  count 2
      CALL FFV1P0_3(W(1,15),W(1,39),GC_11,ZERO,FK_ZERO,W(1,45))  !  count 2
      CALL FFV1P1N_3(W(1,20), W(1,2), GC_11, TMP(1))
      call CombineAmp(4,
     & (/1,3,2,4/), 
     & (/42,43,44,45/),
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX20(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS20/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS20
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX20=SOINDEX_FOR_SQUARED_ORDERS20(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS20(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS20/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS20 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function' 
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS20'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN20(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX20(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX20'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX20(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS20(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS20 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS20'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
