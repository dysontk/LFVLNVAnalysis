            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 41 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX41(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.5.3, 2023-12-23
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_41(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_41/ZEROAMP_41
...
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,11),W(1,1),W(1,10),GC_11,AMP(2))
      CALL FFV2_5_1(W(1,1),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,12),W(1,1),W(1,13),GC_11,AMP(5))
      CALL FFV2_2(W(1,9),W(1,5),GC_100,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,14),W(1,1),W(1,10),GC_11,AMP(6))
      CALL FFV2_1(W(1,1),W(1,5),GC_100,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,9),W(1,14),W(1,10),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,4),W(1,14),W(1,13),GC_11,AMP(8))
      CALL FFV1P0_3(W(1,3),W(1,2),GC_11,ZERO, FK_ZERO,W(1,13))
      CALL FFV1_1(W(1,1),W(1,13),GC_11,ZERO, FK_ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 13
      CALL FFV2_0(W(1,16),W(1,1),W(1,15),GC_100,AMP(13))
...
C     Amplitude(s) for diagram number 16
      ...
      CALL FFV1P0_3(W(1,3),W(1,7),GC_11,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,12),W(1,1),W(1,16),GC_11,AMP(17))
      CALL FFV1P0_3(W(1,3),W(1,14),GC_11,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,8),W(1,2),W(1,12),GC_11,AMP(18))
      CALL FFV1_2(W(1,3),W(1,10),GC_11,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 19
      CALL FFV2_0(W(1,8),W(1,1),W(1,15),GC_100,AMP(19))
      CALL FFV2_2(W(1,3),W(1,15),GC_100,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,2),W(1,1),W(1,10),GC_11,AMP(20))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ +(5.000000000000000D-01)*TMP_JAMP(22)
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX41 = MATRIX41 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_41(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 41, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_41(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 41, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
