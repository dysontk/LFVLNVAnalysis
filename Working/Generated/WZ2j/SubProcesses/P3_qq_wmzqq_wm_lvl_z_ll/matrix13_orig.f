...
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,8),W(1,4),W(1,9),GC_11,AMP(7))
      CALL VVV1_2(W(1,5),W(1,6),GC_53,MDL_MW, FK_MDL_WW,W(1,8))
      CALL FFV1_2(W(1,1),W(1,10),GC_11,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,4),W(1,3),W(1,8),GC_100,AMP(8))
      CALL FFV2_2(W(1,1),W(1,8),GC_100,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,13),W(1,3),W(1,10),GC_11,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV2_3_0(W(1,4),W(1,12),W(1,6),GC_50,GC_58,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,4),W(1,11),W(1,5),GC_100,AMP(11))
