...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_5_2(W(1,3),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_1(W(1,1),W(1,5),GC_100,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,4),W(1,7),W(1,10),GC_11,AMP(3))
      CALL FFV2_1(W(1,2),W(1,5),GC_100,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,4),W(1,10),W(1,9),GC_11,AMP(4))
      CALL FFV1P0_3(W(1,3),W(1,1),GC_11,ZERO, FK_ZERO,W(1,9))
      CALL FFV1_1(W(1,2),W(1,9),GC_11,ZERO, FK_ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV2_3_2(W(1,4),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1_2(W(1,4),W(1,9),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 9
      CALL FFV2_0(W(1,15),W(1,2),W(1,14),GC_100,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,4),W(1,11),W(1,14),GC_100,AMP(10))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV1_1(W(1,1),W(1,15),GC_11,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 13
      CALL FFV2_5_0(W(1,8),W(1,11),W(1,6),-GC_50,GC_58,AMP(13))
      CALL FFV2_5_1(W(1,1),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 16
      ...
      CALL FFV1_2(W(1,4),W(1,15),GC_11,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 17
      CALL FFV2_0(W(1,13),W(1,1),W(1,14),GC_100,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV2_0(W(1,4),W(1,11),W(1,14),GC_100,AMP(18))
...
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,8),W(1,2),W(1,13),GC_11,AMP(21))
      CALL FFV1P0_3(W(1,3),W(1,12),GC_11,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,8),W(1,1),W(1,2),GC_11,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,4),W(1,7),W(1,2),GC_11,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,4),W(1,10),W(1,13),GC_11,AMP(24))
