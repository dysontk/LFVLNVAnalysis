...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1_1(W(1,2),W(1,9),GC_11,ZERO, FK_ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,13),W(1,2),W(1,12),GC_100,AMP(7))
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1P0_3(W(1,1),W(1,13),GC_11,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,8),W(1,2),W(1,3),GC_11,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,4),W(1,7),W(1,3),GC_11,AMP(12))
