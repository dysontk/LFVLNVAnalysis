...
C     
C     Process: u s > w- z u c WEIGHTED<=6 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: c d > w- z c u WEIGHTED<=6 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: u s > w- z u c WEIGHTED<=6 @3
...
C     ----------
     ...
     $  !  count 11
      ...
      CALL FFV1P1N_3(W(1,20), W(1,15), GC_11, TMP(1))
      call CombineAmp(4,
     & (/1,2,3,4/), 
     & (/21,22,23,24/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_1(W(1,15),W(1,6),GC_100,ZERO,FK_ZERO,W(1,25))  !  count 16
     ...
     & TMP, W, AMP(1,2))  !  count 1
      ...
      CALL FFV1_1(W(1,15),W(1,26),GC_11,ZERO,FK_ZERO,W(1,28))  !  count 6
      CALL FFV1_1(W(1,15),W(1,27),GC_11,ZERO,FK_ZERO,W(1,29))  !  count 6
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_5_1(W(1,15),W(1,11),-GC_50,GC_58,ZERO,FK_ZERO,W(1,30))  !  count 4
      CALL FFV2_5_1(W(1,15),W(1,12),-GC_50,GC_58,ZERO,FK_ZERO,W(1,31))  !  count 4
     ...
     & TMP, W, AMP(1,6))  !  count 1
      ...
      CALL FFV2P1N_1(W(1,15), W(1,34), GC_100, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/36,37/),
     & TMP, W, AMP(1,7))
      CALL FFV2P1N_1(W(1,15), W(1,35), GC_100, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/36,37/),
