...
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,12),W(1,1),W(1,10),GC_11,AMP(5))
      CALL FFV2_1(W(1,1),W(1,5),GC_100,ZERO, FK_ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV1_2(W(1,3),W(1,10),GC_11,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,2),W(1,1),W(1,8),GC_100,AMP(8))
      CALL FFV2_2(W(1,3),W(1,8),GC_100,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,13),W(1,1),W(1,10),GC_11,AMP(9))
