...
C     
C     Process: u~ s~ > w- z d~ s~ WEIGHTED<=6 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     Process: c~ d~ > w- z s~ d~ WEIGHTED<=6 @3
C     *   Decay: w- > e- ve~ WEIGHTED<=2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     Process: u~ s~ > w- z d~ s~ WEIGHTED<=6 @3
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL FFV2_3(W(1,5),W(1,4),GC_100,MDL_MW,FK_MDL_WW,W(1,6))  !  count 10
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV2_5_2(W(1,16),W(1,11),-GC_50,GC_58,ZERO,FK_ZERO,W(1,24))  !  count 2
      CALL FFV2_5_2(W(1,16),W(1,12),-GC_50,GC_58,ZERO,FK_ZERO,W(1,25))  !  count 2
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_5_1(W(1,1),W(1,11),-GC_50,GC_58,ZERO,FK_ZERO,W(1,26))  !  count 4
      CALL FFV2_5_1(W(1,1),W(1,12),-GC_50,GC_58,ZERO,FK_ZERO,W(1,27))  !  count 4
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_3_2(W(1,13),W(1,11),GC_50,GC_58,ZERO,FK_ZERO,W(1,32))  !  count 3
      CALL FFV2_3_2(W(1,13),W(1,12),GC_50,GC_58,ZERO,FK_ZERO,W(1,33))  !  count 3
     ...
     & TMP, W, AMP(1,7))  !  count 1
      CALL VVV1_2(W(1,6),W(1,11),GC_53,MDL_MW,FK_MDL_WW,W(1,38))  !  count 3
      CALL VVV1_2(W(1,6),W(1,12),GC_53,MDL_MW,FK_MDL_WW,W(1,39))  !  count 3
