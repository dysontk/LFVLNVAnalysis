            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 21 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX21(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.5.3, 2023-12-23
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_21(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_21/ZEROAMP_21
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV2_5_2(W(1,7),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,11),W(1,2),W(1,10),GC_11,AMP(2))
      CALL FFV2_5_1(W(1,2),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,7),W(1,11),W(1,10),GC_11,AMP(3))
      CALL FFV2_3_1(W(1,3),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 9
      CALL FFV2_5_0(W(1,12),W(1,9),W(1,6),-GC_50,GC_58,AMP(9))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL VVV1_2(W(1,5),W(1,6),GC_53,MDL_MW, FK_MDL_WW,W(1,15))
...
C     Amplitude(s) for diagram number 15
      CALL FFV2_3_0(W(1,16),W(1,14),W(1,6),GC_50,GC_58,AMP(15))
...
C     Amplitude(s) for diagram number 21
      CALL FFV2_3_0(W(1,8),W(1,14),W(1,6),GC_50,GC_58,AMP(21))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ +(5.000000000000000D-01)*TMP_JAMP(22)
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX21 = MATRIX21 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_21(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 21, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_21(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 21, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
