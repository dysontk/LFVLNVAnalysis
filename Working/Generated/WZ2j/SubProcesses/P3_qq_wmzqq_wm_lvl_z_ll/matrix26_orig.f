...
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,1),W(1,7),W(1,9),GC_11,AMP(2))
      CALL FFV1P0_3(W(1,4),W(1,2),GC_11,ZERO, FK_ZERO,W(1,9))
      CALL FFV1_1(W(1,3),W(1,9),GC_11,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,8),W(1,10),W(1,6),-GC_50,GC_58,AMP(3))
      CALL FFV2_5_1(W(1,3),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,8),W(1,11),W(1,9),GC_11,AMP(4))
      CALL FFV2_3_2(W(1,1),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,12),W(1,10),W(1,5),GC_100,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,12),W(1,7),W(1,9),GC_11,AMP(6))
      CALL VVV1_2(W(1,5),W(1,6),GC_53,MDL_MW, FK_MDL_WW,W(1,12))
      CALL FFV1_2(W(1,1),W(1,9),GC_11,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,13),W(1,3),W(1,12),GC_100,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,1),W(1,10),W(1,12),GC_100,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV2_3_0(W(1,13),W(1,7),W(1,6),GC_50,GC_58,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,13),W(1,11),W(1,5),GC_100,AMP(10))
      CALL FFV2_5_1(W(1,2),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,13))
      CALL FFV1P0_3(W(1,4),W(1,13),GC_11,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,8),W(1,3),W(1,6),GC_11,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,1),W(1,7),W(1,6),GC_11,AMP(12))
