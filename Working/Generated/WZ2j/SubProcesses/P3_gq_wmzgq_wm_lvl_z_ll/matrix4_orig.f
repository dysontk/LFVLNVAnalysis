...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_3_2(W(1,4),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 27
      CALL FFV2_5_0(W(1,4),W(1,16),W(1,6),-GC_50,GC_58,AMP(27))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      JAMP(1,1) = AMP(9)+AMP(10)+AMP(11)+AMP(12)+AMP(13)+AMP(14)
     $ +AMP(15)+AMP(16)+AMP(30)+AMP(31)+AMP(32)+AMP(33)+AMP(34)+AMP(35)
     $ +AMP(38)+((0.000000000000000D+00,-1.000000000000000D+00))
     $ *TMP_JAMP(7)
      JAMP(2,1) = AMP(17)+AMP(18)+AMP(19)+AMP(20)+AMP(21)+AMP(22)
     $ +AMP(23)+AMP(24)+AMP(25)+AMP(26)+AMP(27)+AMP(28)+AMP(29)+AMP(36)
     $ +AMP(37)+((0.000000000000000D+00,1.000000000000000D+00))
     $ *TMP_JAMP(7)
