            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 3 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX3(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.5.3, 2023-12-23
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_3(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_3/ZEROAMP_3
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL VVV1_1(W(1,5),W(1,6),GC_53,MDL_MW, FK_MDL_WW,W(1,8))
      CALL FFV1_1(W(1,2),W(1,7),GC_11,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,4),W(1,9),W(1,8),GC_100,AMP(1))
      CALL FFV1_2(W(1,4),W(1,7),GC_11,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,10),W(1,2),W(1,8),GC_100,AMP(2))
      CALL FFV2_1(W(1,2),W(1,5),GC_100,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,10),W(1,11),W(1,6),-GC_50,GC_58,AMP(3))
      CALL FFV2_5_2(W(1,4),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,12),W(1,11),W(1,7),GC_11,AMP(4))
      CALL FFV2_2(W(1,4),W(1,5),GC_100,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 5
      CALL FFV2_3_0(W(1,13),W(1,9),W(1,6),GC_50,GC_58,AMP(5))
      CALL FFV2_3_1(W(1,2),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,13),W(1,14),W(1,7),GC_11,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,10),W(1,14),W(1,5),GC_100,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,12),W(1,9),W(1,5),GC_100,AMP(8))
      CALL FFV1_1(W(1,2),W(1,1),GC_11,ZERO, FK_ZERO,W(1,9))
      CALL FFV1_2(W(1,4),W(1,3),GC_11,ZERO, FK_ZERO,W(1,10))
      CALL FFV2_1(W(1,9),W(1,5),GC_100,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 9
      CALL FFV2_5_0(W(1,10),W(1,7),W(1,6),-GC_50,GC_58,AMP(9))
      CALL FFV2_3_1(W(1,9),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,10),W(1,15),W(1,5),GC_100,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,10),W(1,9),W(1,8),GC_100,AMP(11))
      CALL FFV1_1(W(1,9),W(1,3),GC_11,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 12
      CALL FFV2_0(W(1,4),W(1,16),W(1,8),GC_100,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV2_3_0(W(1,13),W(1,16),W(1,6),GC_50,GC_58,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,13),W(1,15),W(1,3),GC_11,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,12),W(1,16),W(1,5),GC_100,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,12),W(1,7),W(1,3),GC_11,AMP(16))
      CALL FFV1_2(W(1,4),W(1,1),GC_11,ZERO, FK_ZERO,W(1,7))
      CALL FFV1_1(W(1,2),W(1,3),GC_11,ZERO, FK_ZERO,W(1,16))
      CALL FFV2_2(W(1,7),W(1,5),GC_100,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 17
      CALL FFV2_3_0(W(1,15),W(1,16),W(1,6),GC_50,GC_58,AMP(17))
      CALL FFV2_5_2(W(1,7),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 18
      CALL FFV2_0(W(1,9),W(1,16),W(1,5),GC_100,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV2_0(W(1,7),W(1,16),W(1,8),GC_100,AMP(19))
      CALL FFV1_2(W(1,7),W(1,3),GC_11,ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 20
      CALL FFV2_0(W(1,17),W(1,2),W(1,8),GC_100,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV2_5_0(W(1,17),W(1,11),W(1,6),-GC_50,GC_58,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,9),W(1,11),W(1,3),GC_11,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_0(W(1,17),W(1,14),W(1,5),GC_100,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,15),W(1,14),W(1,3),GC_11,AMP(24))
      CALL FFV1_1(W(1,16),W(1,1),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 25
      CALL FFV2_0(W(1,4),W(1,15),W(1,8),GC_100,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV2_3_0(W(1,13),W(1,15),W(1,6),GC_50,GC_58,AMP(26))
      CALL FFV1_2(W(1,13),W(1,1),GC_11,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 27
      CALL FFV2_3_0(W(1,4),W(1,16),W(1,6),GC_50,GC_58,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV2_0(W(1,12),W(1,15),W(1,5),GC_100,AMP(28))
      CALL FFV1_2(W(1,12),W(1,1),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 29
      CALL FFV2_0(W(1,15),W(1,16),W(1,5),GC_100,AMP(29))
      CALL FFV1_2(W(1,10),W(1,1),GC_11,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 30
      CALL FFV2_0(W(1,16),W(1,2),W(1,8),GC_100,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV2_5_0(W(1,16),W(1,11),W(1,6),-GC_50,GC_58,AMP(31))
      CALL FFV1_1(W(1,11),W(1,1),GC_11,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 32
      CALL FFV2_5_0(W(1,10),W(1,8),W(1,6),-GC_50,GC_58,AMP(32))
C     Amplitude(s) for diagram number 33
      CALL FFV2_0(W(1,16),W(1,14),W(1,5),GC_100,AMP(33))
      CALL FFV1_1(W(1,14),W(1,1),GC_11,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 34
      CALL FFV2_0(W(1,10),W(1,16),W(1,5),GC_100,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,12),W(1,8),W(1,3),GC_11,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL FFV1_0(W(1,15),W(1,11),W(1,3),GC_11,AMP(36))
C     Amplitude(s) for diagram number 37
      CALL FFV1_0(W(1,4),W(1,14),W(1,3),GC_11,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,13),W(1,16),W(1,3),GC_11,AMP(38))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      TMP_JAMP(4) = AMP(7) +  AMP(8)  ! used 2 times
      ...
      JAMP(1,1) = (-1.000000000000000D+00)*AMP(9)+(-1.000000000000000D
     $ +00)*AMP(10)+(-1.000000000000000D+00)*AMP(11)+(
     $ -1.000000000000000D+00)*AMP(12)+(-1.000000000000000D+00)*AMP(13)
     $ +(-1.000000000000000D+00)*AMP(14)+(-1.000000000000000D+00)
     $ *AMP(15)+(-1.000000000000000D+00)*AMP(16)+(-1.000000000000000D
     $ +00)*AMP(30)+(-1.000000000000000D+00)*AMP(31)+(
     $ -1.000000000000000D+00)*AMP(32)+(-1.000000000000000D+00)*AMP(33)
     $ +(-1.000000000000000D+00)*AMP(34)+(-1.000000000000000D+00)
     $ *AMP(35)+(-1.000000000000000D+00)*AMP(38)+((0.000000000000000D
     $ +00,1.000000000000000D+00))*TMP_JAMP(7)
      JAMP(2,1) = (-1.000000000000000D+00)*AMP(17)+(
     $ -1.000000000000000D+00)*AMP(18)+(-1.000000000000000D+00)*AMP(19)
     $ +(-1.000000000000000D+00)*AMP(20)+(-1.000000000000000D+00)
     $ *AMP(21)+(-1.000000000000000D+00)*AMP(22)+(-1.000000000000000D
     $ +00)*AMP(23)+(-1.000000000000000D+00)*AMP(24)+(
     $ -1.000000000000000D+00)*AMP(25)+(-1.000000000000000D+00)*AMP(26)
     $ +(-1.000000000000000D+00)*AMP(27)+(-1.000000000000000D+00)
     $ *AMP(28)+(-1.000000000000000D+00)*AMP(29)+(-1.000000000000000D
     $ +00)*AMP(36)+(-1.000000000000000D+00)*AMP(37)
     $ +((0.000000000000000D+00,-1.000000000000000D+00))*TMP_JAMP(7)

      IF(INIT_MODE)THEN
        DO I=1, NGRAPHS
          IF (AMP(I).NE.0) THEN
            ZEROAMP_3(IHEL,I) = .FALSE.
          ENDIF
        ENDDO
      ENDIF
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX3 = MATRIX3 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_3(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 3, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_3(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 3, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
