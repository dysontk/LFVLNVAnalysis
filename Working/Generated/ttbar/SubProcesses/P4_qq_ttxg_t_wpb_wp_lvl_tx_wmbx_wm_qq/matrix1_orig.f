...
C     
C     Process: u u~ > t t~ g WEIGHTED<=3 @4
C     *   Decay: t > w+ b WEIGHTED<=2
C     *     Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: t~ > w- b~ WEIGHTED<=2
C     *     Decay: w- > d u~ WEIGHTED<=2
C     Process: c c~ > t t~ g WEIGHTED<=3 @4
C     *   Decay: t > w+ b WEIGHTED<=2
C     *     Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: t~ > w- b~ WEIGHTED<=2
C     *     Decay: w- > d u~ WEIGHTED<=2
C     Process: d d~ > t t~ g WEIGHTED<=3 @4
C     *   Decay: t > w+ b WEIGHTED<=2
C     *     Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: t~ > w- b~ WEIGHTED<=2
C     *     Decay: w- > d u~ WEIGHTED<=2
C     Process: s s~ > t t~ g WEIGHTED<=3 @4
C     *   Decay: t > w+ b WEIGHTED<=2
C     *     Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: t~ > w- b~ WEIGHTED<=2
C     *     Decay: w- > d u~ WEIGHTED<=2
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1_1(W(1,3),W(1,5),GC_11,MDL_MT, FK_MDL_WT,W(1,6))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_11,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,4),W(1,6),W(1,8),GC_11,AMP(2))
      CALL FFV1_2(W(1,4),W(1,5),GC_11,MDL_MT, FK_MDL_WT,W(1,6))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,6),W(1,3),W(1,8),GC_11,AMP(3))
      CALL FFV1_1(W(1,2),W(1,5),GC_11,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,1),W(1,6),W(1,7),GC_11,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVV1_0(W(1,5),W(1,8),W(1,7),GC_10,AMP(5))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = (-1.666666666666667D-01)*AMP(2)+(-1.666666666666667D
     $ -01)*AMP(3)
      JAMP(2,1) = (5.000000000000000D-01)*AMP(1)+(5.000000000000000D
     $ -01)*AMP(2)+((0.000000000000000D+00,-5.000000000000000D-01))
     $ *AMP(5)
      JAMP(3,1) = (5.000000000000000D-01)*AMP(3)+(5.000000000000000D
