...
C     
C     Process: g g > t t~ WEIGHTED<=2 @2
...
C     COLOR DATA
C     
      DATA (CF(I,  1),I=  1,  2) /1.600000000000000D+01,
     $ -2.000000000000000D+00/
C     1 T(1,2,5,8) T(6,7)
      DATA (CF(I,  2),I=  1,  2) /-2.000000000000000D+00
     $ ,1.600000000000000D+01/
C     1 T(2,1,5,8) T(6,7)
C     ----------
C     BEGIN CODE
C     ----------
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1_1(W(1,3),W(1,1),GC_11,MDL_MT, ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,4),W(1,5),W(1,2),GC_11,AMP(2))
      CALL FFV1_2(W(1,4),W(1,1),GC_11,MDL_MT, ZERO,W(1,5))
