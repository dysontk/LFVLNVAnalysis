...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WW)
      ...
      CALL OXXXXX(P(0,9),ZERO,NHEL(9),+1*IC(9),W(1,5))
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1P0_3(W(1,2),W(1,5),GC_11,ZERO, FK_ZERO,W(1,8))
