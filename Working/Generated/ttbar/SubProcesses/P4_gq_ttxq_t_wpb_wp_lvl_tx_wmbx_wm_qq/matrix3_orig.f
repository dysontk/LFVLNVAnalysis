...
C     
C     Process: g u~ > t t~ u~ WEIGHTED<=3 @4
C     *   Decay: t > w+ b WEIGHTED<=2
C     *     Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: t~ > w- b~ WEIGHTED<=2
C     *     Decay: w- > s c~ WEIGHTED<=2
C     Process: g c~ > t t~ c~ WEIGHTED<=3 @4
C     *   Decay: t > w+ b WEIGHTED<=2
C     *     Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: t~ > w- b~ WEIGHTED<=2
C     *     Decay: w- > s c~ WEIGHTED<=2
C     Process: g d~ > t t~ d~ WEIGHTED<=3 @4
C     *   Decay: t > w+ b WEIGHTED<=2
C     *     Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: t~ > w- b~ WEIGHTED<=2
C     *     Decay: w- > s c~ WEIGHTED<=2
C     Process: g s~ > t t~ s~ WEIGHTED<=3 @4
C     *   Decay: t > w+ b WEIGHTED<=2
C     *     Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: t~ > w- b~ WEIGHTED<=2
C     *     Decay: w- > s c~ WEIGHTED<=2
...
C     COLOR DATA
C     
      DATA (CF(I,  1),I=  1,  4) /3.600000000000000D+01
     $ ,1.200000000000000D+01,1.200000000000000D+01,0.000000000000000D
     $ +00/
C     1 T(1,2,8) T(5,9) T(6,7)
      DATA (CF(I,  2),I=  1,  4) /1.200000000000000D+01
     $ ,3.600000000000000D+01,0.000000000000000D+00,1.200000000000000D
     $ +01/
C     1 T(1,2,9) T(5,8) T(6,7)
      DATA (CF(I,  3),I=  1,  4) /1.200000000000000D+01
     $ ,0.000000000000000D+00,3.600000000000000D+01,1.200000000000000D
     $ +01/
C     1 T(1,5,8) T(2,9) T(6,7)
      DATA (CF(I,  4),I=  1,  4) /0.000000000000000D+00
     $ ,1.200000000000000D+01,1.200000000000000D+01,3.600000000000000D
     $ +01/
C     1 T(1,5,9) T(2,8) T(6,7)
C     ----------
C     BEGIN CODE
C     ----------
      IF (FIRST) THEN
...
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,2),W(1,7),GC_11,AMP(1))
      CALL FFV1_1(W(1,3),W(1,1),GC_11,MDL_MT, ZERO,W(1,6))
      CALL FFV1P0_3(W(1,5),W(1,2),GC_11,ZERO, FK_ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,5),W(1,6),W(1,7),GC_11,AMP(4))
