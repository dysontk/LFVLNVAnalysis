...
C     
C     Process: u u~ > t t~ g WEIGHTED<=3 @3
C     *   Decay: t > w+ b WEIGHTED<=2
C     *     Decay: w+ > u d~ WEIGHTED<=2
C     *   Decay: t~ > w- b~ WEIGHTED<=2
C     *     Decay: w- > e- ve~ WEIGHTED<=2
C     Process: c c~ > t t~ g WEIGHTED<=3 @3
C     *   Decay: t > w+ b WEIGHTED<=2
C     *     Decay: w+ > u d~ WEIGHTED<=2
C     *   Decay: t~ > w- b~ WEIGHTED<=2
C     *     Decay: w- > e- ve~ WEIGHTED<=2
C     Process: d d~ > t t~ g WEIGHTED<=3 @3
C     *   Decay: t > w+ b WEIGHTED<=2
C     *     Decay: w+ > u d~ WEIGHTED<=2
C     *   Decay: t~ > w- b~ WEIGHTED<=2
C     *     Decay: w- > e- ve~ WEIGHTED<=2
C     Process: s s~ > t t~ g WEIGHTED<=3 @3
C     *   Decay: t > w+ b WEIGHTED<=2
C     *     Decay: w+ > u d~ WEIGHTED<=2
C     *   Decay: t~ > w- b~ WEIGHTED<=2
C     *     Decay: w- > e- ve~ WEIGHTED<=2
