...
C     
C     Process: g g > t t~ g WEIGHTED<=3 @4
...
C     COLOR DATA
C     
      DATA (CF(I,  1),I=  1,  6) /2.133333333333333D+01,
     $ -2.666666666666667D+00,-2.666666666666667D+00
     $ ,3.333333333333333D-01,3.333333333333333D-01,3.333333333333333D
     $ +00/
C     1 T(1,2,9,5,8) T(6,7)
      DATA (CF(I,  2),I=  1,  6) /-2.666666666666667D+00
     $ ,2.133333333333333D+01,3.333333333333333D-01,3.333333333333333D
     $ +00,-2.666666666666667D+00,3.333333333333333D-01/
C     1 T(1,9,2,5,8) T(6,7)
      DATA (CF(I,  3),I=  1,  6) /-2.666666666666667D+00
     $ ,3.333333333333333D-01,2.133333333333333D+01,
     $ -2.666666666666667D+00,3.333333333333333D+00,3.333333333333333D
     $ -01/
C     1 T(2,1,9,5,8) T(6,7)
      DATA (CF(I,  4),I=  1,  6) /3.333333333333333D-01
     $ ,3.333333333333333D+00,-2.666666666666667D+00
     $ ,2.133333333333333D+01,3.333333333333333D-01,
     $ -2.666666666666667D+00/
C     1 T(2,9,1,5,8) T(6,7)
      DATA (CF(I,  5),I=  1,  6) /3.333333333333333D-01,
     $ -2.666666666666667D+00,3.333333333333333D+00,3.333333333333333D
     $ -01,2.133333333333333D+01,-2.666666666666667D+00/
C     1 T(6,7) T(9,1,2,5,8)
      DATA (CF(I,  6),I=  1,  6) /3.333333333333333D+00
     $ ,3.333333333333333D-01,3.333333333333333D-01,
     $ -2.666666666666667D+00,-2.666666666666667D+00
     $ ,2.133333333333333D+01/
C     1 T(6,7) T(9,2,1,5,8)
C     ----------
C     BEGIN CODE
C     ----------
      IF (FIRST) THEN
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WW)
      ...
      CALL FFV2_1(W(1,4),W(1,5),GC_100,MDL_MT, FK_MDL_WT,W(1,3))
      CALL OXXXXX(P(0,6),ZERO,NHEL(6),+1*IC(6),W(1,4))
      CALL IXXXXX(P(0,7),ZERO,NHEL(7),-1*IC(7),W(1,5))
      CALL FFV2_3(W(1,5),W(1,4),GC_100,MDL_MW, FK_MDL_WW,W(1,6))
      CALL IXXXXX(P(0,8),MDL_MB,NHEL(8),-1*IC(8),W(1,5))
      CALL FFV2_2(W(1,5),W(1,6),GC_100,MDL_MT, FK_MDL_WT,W(1,4))
      CALL VXXXXX(P(0,9),ZERO,NHEL(9),+1*IC(9),W(1,5))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_10,ZERO, FK_ZERO,W(1,6))
      CALL FFV1P0_3(W(1,4),W(1,3),GC_11,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(1,6),W(1,7),W(1,5),GC_10,AMP(1))
      CALL FFV1_1(W(1,3),W(1,5),GC_11,MDL_MT, FK_MDL_WT,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,4),W(1,8),W(1,6),GC_11,AMP(2))
      CALL FFV1_2(W(1,4),W(1,5),GC_11,MDL_MT, FK_MDL_WT,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,9),W(1,3),W(1,6),GC_11,AMP(3))
      CALL FFV1_1(W(1,3),W(1,1),GC_11,MDL_MT, ZERO,W(1,6))
      CALL FFV1_2(W(1,4),W(1,2),GC_11,MDL_MT, ZERO,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,10),W(1,6),W(1,5),GC_11,AMP(4))
      CALL VVV1P0_1(W(1,2),W(1,5),GC_10,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,4),W(1,6),W(1,11),GC_11,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,9),W(1,6),W(1,2),GC_11,AMP(6))
      CALL FFV1_2(W(1,4),W(1,1),GC_11,MDL_MT, ZERO,W(1,6))
      CALL FFV1_1(W(1,3),W(1,2),GC_11,MDL_MT, ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 9
      ...
      CALL VVV1P0_1(W(1,1),W(1,5),GC_10,ZERO, FK_ZERO,W(1,6))
...
C     Amplitude(s) for diagram number 15
      ...
      CALL VVVV1P0_1(W(1,1),W(1,2),W(1,5),GC_12,ZERO, FK_ZERO,W(1,11))
      CALL VVVV3P0_1(W(1,1),W(1,2),W(1,5),GC_12,ZERO, FK_ZERO,W(1,7))
      CALL VVVV4P0_1(W(1,1),W(1,2),W(1,5),GC_12,ZERO, FK_ZERO,W(1,10))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -1.000000000000000D+00)) * AMP(10)  ! used 2 times
      JAMP(1,1) = AMP(6)+TMP_JAMP(6)+(-1.000000000000000D+00)
     $ *TMP_JAMP(8)
      JAMP(2,1) = AMP(4)+(-1.000000000000000D+00)*TMP_JAMP(5)
     $ +TMP_JAMP(8)
      JAMP(3,1) = AMP(13)+TMP_JAMP(4)+(-1.000000000000000D+00)
     $ *TMP_JAMP(6)
      JAMP(4,1) = AMP(7)+(-1.000000000000000D+00)*TMP_JAMP(4)
     $ +TMP_JAMP(9)
      JAMP(5,1) = AMP(14)+TMP_JAMP(5)+(-1.000000000000000D+00)
     $ *TMP_JAMP(7)
      JAMP(6,1) = AMP(9)+TMP_JAMP(7)+(-1.000000000000000D+00)
     $ *TMP_JAMP(9)
