...
C     
C     Process: u u~ > t t~ WEIGHTED<=2 @2
C     *   Decay: t > w+ b WEIGHTED<=2
C     *     Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: t~ > w- b~ WEIGHTED<=2
C     *     Decay: w- > d u~ WEIGHTED<=2
C     Process: c c~ > t t~ WEIGHTED<=2 @2
C     *   Decay: t > w+ b WEIGHTED<=2
C     *     Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: t~ > w- b~ WEIGHTED<=2
C     *     Decay: w- > d u~ WEIGHTED<=2
C     Process: d d~ > t t~ WEIGHTED<=2 @2
C     *   Decay: t > w+ b WEIGHTED<=2
C     *     Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: t~ > w- b~ WEIGHTED<=2
C     *     Decay: w- > d u~ WEIGHTED<=2
C     Process: s s~ > t t~ WEIGHTED<=2 @2
C     *   Decay: t > w+ b WEIGHTED<=2
C     *     Decay: w+ > e+ ve WEIGHTED<=2
C     *   Decay: t~ > w- b~ WEIGHTED<=2
C     *     Decay: w- > d u~ WEIGHTED<=2
