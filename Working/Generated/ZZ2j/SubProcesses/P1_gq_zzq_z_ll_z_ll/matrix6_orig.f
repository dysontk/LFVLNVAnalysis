...
C     
C     Process: g u~ > z z u~ WEIGHTED<=5 @1
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: g c~ > z z c~ WEIGHTED<=5 @1
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     
      USE DISCRETESAMPLER
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV1_2(W(1,3),W(1,1),GC_11,ZERO, FK_ZERO,W(1,4))
      CALL FFV2_5_1(W(1,2),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV2_5_0(W(1,4),W(1,7),W(1,6),-GC_50,GC_58,AMP(1))
      CALL FFV2_5_1(W(1,2),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV2_5_0(W(1,4),W(1,8),W(1,5),-GC_50,GC_58,AMP(2))
      CALL FFV1_1(W(1,2),W(1,1),GC_11,ZERO, FK_ZERO,W(1,4))
      CALL FFV2_5_2(W(1,3),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,2),W(1,4),W(1,6),-GC_50,GC_58,AMP(3))
      CALL FFV2_5_2(W(1,3),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 4
      CALL FFV2_5_0(W(1,9),W(1,4),W(1,5),-GC_50,GC_58,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,2),W(1,8),W(1,1),GC_11,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,9),W(1,7),W(1,1),GC_11,AMP(6))
