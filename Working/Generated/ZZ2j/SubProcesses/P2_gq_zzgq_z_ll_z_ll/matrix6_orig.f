...
C     
C     Process: g u~ > z z g u~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: g c~ > z z g c~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     
      USE DISCRETESAMPLER
            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 6 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX6(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.5.3, 2023-12-23
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_6(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_6/ZEROAMP_6
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL VXXXXX(P(0,7),ZERO,NHEL(7),+1*IC(7),W(1,3))
      CALL IXXXXX(P(0,8),ZERO,NHEL(8),-1*IC(8),W(1,4))
      CALL VVV1P0_1(W(1,1),W(1,3),GC_10,ZERO, FK_ZERO,W(1,7))
      CALL FFV2_5_1(W(1,2),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,8))
      CALL FFV1_2(W(1,4),W(1,7),GC_11,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV2_5_0(W(1,9),W(1,8),W(1,6),-GC_50,GC_58,AMP(1))
      CALL FFV2_5_2(W(1,4),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,10),W(1,8),W(1,7),GC_11,AMP(2))
      CALL FFV2_5_2(W(1,4),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,11))
      CALL FFV1_1(W(1,2),W(1,7),GC_11,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,11),W(1,12),W(1,6),-GC_50,GC_58,AMP(3))
      CALL FFV2_5_1(W(1,2),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,11),W(1,13),W(1,7),GC_11,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV2_5_0(W(1,9),W(1,13),W(1,5),-GC_50,GC_58,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_5_0(W(1,10),W(1,12),W(1,5),-GC_50,GC_58,AMP(6))
      CALL FFV1_1(W(1,2),W(1,1),GC_11,ZERO, FK_ZERO,W(1,12))
      CALL FFV1_2(W(1,4),W(1,3),GC_11,ZERO, FK_ZERO,W(1,9))
      CALL FFV2_5_1(W(1,12),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 7
      CALL FFV2_5_0(W(1,9),W(1,7),W(1,6),-GC_50,GC_58,AMP(7))
      CALL FFV2_5_1(W(1,12),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 8
      CALL FFV2_5_0(W(1,9),W(1,14),W(1,5),-GC_50,GC_58,AMP(8))
      CALL FFV1_1(W(1,12),W(1,3),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 9
      CALL FFV2_5_0(W(1,11),W(1,15),W(1,6),-GC_50,GC_58,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,11),W(1,14),W(1,3),GC_11,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_5_0(W(1,10),W(1,15),W(1,5),-GC_50,GC_58,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,10),W(1,7),W(1,3),GC_11,AMP(12))
      CALL FFV1_2(W(1,4),W(1,1),GC_11,ZERO, FK_ZERO,W(1,7))
      CALL FFV1_1(W(1,2),W(1,3),GC_11,ZERO, FK_ZERO,W(1,4))
      CALL FFV2_5_2(W(1,7),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 13
      CALL FFV2_5_0(W(1,2),W(1,4),W(1,6),-GC_50,GC_58,AMP(13))
      CALL FFV2_5_2(W(1,7),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 14
      CALL FFV2_5_0(W(1,15),W(1,4),W(1,5),-GC_50,GC_58,AMP(14))
      CALL FFV1_2(W(1,7),W(1,3),GC_11,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 15
      CALL FFV2_5_0(W(1,14),W(1,8),W(1,6),-GC_50,GC_58,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,15),W(1,8),W(1,3),GC_11,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV2_5_0(W(1,14),W(1,13),W(1,5),-GC_50,GC_58,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,2),W(1,13),W(1,3),GC_11,AMP(18))
      CALL FFV1_1(W(1,4),W(1,1),GC_11,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 19
      CALL FFV2_5_0(W(1,11),W(1,2),W(1,6),-GC_50,GC_58,AMP(19))
      CALL FFV1_2(W(1,11),W(1,1),GC_11,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 20
      CALL FFV2_5_0(W(1,14),W(1,4),W(1,6),-GC_50,GC_58,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV2_5_0(W(1,10),W(1,2),W(1,5),-GC_50,GC_58,AMP(21))
      CALL FFV1_2(W(1,10),W(1,1),GC_11,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 22
      CALL FFV2_5_0(W(1,2),W(1,4),W(1,5),-GC_50,GC_58,AMP(22))
      CALL FFV1_2(W(1,9),W(1,1),GC_11,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 23
      CALL FFV2_5_0(W(1,4),W(1,8),W(1,6),-GC_50,GC_58,AMP(23))
      CALL FFV1_1(W(1,8),W(1,1),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 24
      CALL FFV2_5_0(W(1,9),W(1,15),W(1,6),-GC_50,GC_58,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL FFV2_5_0(W(1,4),W(1,13),W(1,5),-GC_50,GC_58,AMP(25))
      CALL FFV1_1(W(1,13),W(1,1),GC_11,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 26
      CALL FFV2_5_0(W(1,9),W(1,4),W(1,5),-GC_50,GC_58,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,10),W(1,15),W(1,3),GC_11,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,2),W(1,8),W(1,3),GC_11,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,14),W(1,13),W(1,3),GC_11,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,11),W(1,4),W(1,3),GC_11,AMP(30))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      TMP_JAMP(3) = AMP(5) +  AMP(6)  ! used 2 times
      ...
      JAMP(1,1) = (-1.000000000000000D+00)*AMP(7)+(-1.000000000000000D
     ...
     $ *AMP(23)+(-1.000000000000000D+00)*AMP(24)+(-1.000000000000000D
     $ +00)*AMP(25)+(-1.000000000000000D+00)*AMP(26)+(
     $ -1.000000000000000D+00)*AMP(27)+(-1.000000000000000D+00)*AMP(30)
     $ +((0.000000000000000D+00,1.000000000000000D+00))*TMP_JAMP(5)
      JAMP(2,1) = (-1.000000000000000D+00)*AMP(13)+(
     $ -1.000000000000000D+00)*AMP(14)+(-1.000000000000000D+00)*AMP(15)
     $ +(-1.000000000000000D+00)*AMP(16)+(-1.000000000000000D+00)
     $ *AMP(17)+(-1.000000000000000D+00)*AMP(18)+(-1.000000000000000D
     $ +00)*AMP(19)+(-1.000000000000000D+00)*AMP(20)+(
     $ -1.000000000000000D+00)*AMP(21)+(-1.000000000000000D+00)*AMP(22)
     $ +(-1.000000000000000D+00)*AMP(28)+(-1.000000000000000D+00)
     $ *AMP(29)+((0.000000000000000D+00,-1.000000000000000D+00))
     $ *TMP_JAMP(5)

      IF(INIT_MODE)THEN
        DO I=1, NGRAPHS
          IF (AMP(I).NE.0) THEN
            ZEROAMP_6(IHEL,I) = .FALSE.
          ENDIF
        ENDDO
      ENDIF
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX6 = MATRIX6 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_6(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 6, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_6(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 6, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
