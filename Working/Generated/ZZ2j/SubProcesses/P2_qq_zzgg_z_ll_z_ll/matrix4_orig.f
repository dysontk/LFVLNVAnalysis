...
C     
C     Process: d d~ > z z g g WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: s s~ > z z g g WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     
      USE DISCRETESAMPLER
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV1_2(W(1,1),W(1,7),GC_11,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV2_3_0(W(1,9),W(1,8),W(1,6),GC_50,GC_58,AMP(1))
      CALL FFV2_3_2(W(1,1),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,10),W(1,8),W(1,7),GC_11,AMP(2))
      CALL FFV2_3_2(W(1,1),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_1(W(1,2),W(1,3),GC_11,ZERO, FK_ZERO,W(1,12))
      CALL FFV1_2(W(1,1),W(1,4),GC_11,ZERO, FK_ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1_1(W(1,12),W(1,4),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 9
      CALL FFV2_3_0(W(1,11),W(1,15),W(1,6),GC_50,GC_58,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,11),W(1,14),W(1,4),GC_11,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_3_0(W(1,10),W(1,15),W(1,5),GC_50,GC_58,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,10),W(1,7),W(1,4),GC_11,AMP(12))
      CALL FFV1_2(W(1,1),W(1,3),GC_11,ZERO, FK_ZERO,W(1,7))
      CALL FFV1_1(W(1,2),W(1,4),GC_11,ZERO, FK_ZERO,W(1,1))
      CALL FFV2_3_2(W(1,7),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 13
      CALL FFV2_3_0(W(1,2),W(1,1),W(1,6),GC_50,GC_58,AMP(13))
      CALL FFV2_3_2(W(1,7),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 14
      CALL FFV2_3_0(W(1,15),W(1,1),W(1,5),GC_50,GC_58,AMP(14))
      CALL FFV1_2(W(1,7),W(1,4),GC_11,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 15
      CALL FFV2_3_0(W(1,14),W(1,8),W(1,6),GC_50,GC_58,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,15),W(1,8),W(1,4),GC_11,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV2_3_0(W(1,14),W(1,13),W(1,5),GC_50,GC_58,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,2),W(1,13),W(1,4),GC_11,AMP(18))
      CALL FFV1_1(W(1,1),W(1,3),GC_11,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 19
      CALL FFV2_3_0(W(1,11),W(1,2),W(1,6),GC_50,GC_58,AMP(19))
      CALL FFV1_2(W(1,11),W(1,3),GC_11,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 20
      CALL FFV2_3_0(W(1,14),W(1,1),W(1,6),GC_50,GC_58,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV2_3_0(W(1,10),W(1,2),W(1,5),GC_50,GC_58,AMP(21))
      CALL FFV1_2(W(1,10),W(1,3),GC_11,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 22
      CALL FFV2_3_0(W(1,2),W(1,1),W(1,5),GC_50,GC_58,AMP(22))
      CALL FFV1_2(W(1,9),W(1,3),GC_11,ZERO, FK_ZERO,W(1,1))
C     Amplitude(s) for diagram number 23
      CALL FFV2_3_0(W(1,1),W(1,8),W(1,6),GC_50,GC_58,AMP(23))
      CALL FFV1_1(W(1,8),W(1,3),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 24
      CALL FFV2_3_0(W(1,9),W(1,15),W(1,6),GC_50,GC_58,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL FFV2_3_0(W(1,1),W(1,13),W(1,5),GC_50,GC_58,AMP(25))
      CALL FFV1_1(W(1,13),W(1,3),GC_11,ZERO, FK_ZERO,W(1,1))
C     Amplitude(s) for diagram number 26
      CALL FFV2_3_0(W(1,9),W(1,1),W(1,5),GC_50,GC_58,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,10),W(1,15),W(1,4),GC_11,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,2),W(1,8),W(1,4),GC_11,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,14),W(1,13),W(1,4),GC_11,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,11),W(1,1),W(1,4),GC_11,AMP(30))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      JAMP(1,1) = AMP(7)+AMP(8)+AMP(9)+AMP(10)+AMP(11)+AMP(12)+AMP(23)
     $ +AMP(24)+AMP(25)+AMP(26)+AMP(27)+AMP(30)+((0.000000000000000D
     $ +00,-1.000000000000000D+00))*TMP_JAMP(5)
      JAMP(2,1) = AMP(13)+AMP(14)+AMP(15)+AMP(16)+AMP(17)+AMP(18)
     $ +AMP(19)+AMP(20)+AMP(21)+AMP(22)+AMP(28)+AMP(29)
