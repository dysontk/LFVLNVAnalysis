...
C     
C     Process: u u~ > z z g g WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: c c~ > z z g g WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     
      USE DISCRETESAMPLER
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV2_5_2(W(1,1),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,10),W(1,8),W(1,7),GC_11,AMP(2))
      CALL FFV2_5_2(W(1,1),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 13
      CALL FFV2_5_0(W(1,2),W(1,1),W(1,6),-GC_50,GC_58,AMP(13))
      CALL FFV2_5_2(W(1,7),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 14
      CALL FFV2_5_0(W(1,15),W(1,1),W(1,5),-GC_50,GC_58,AMP(14))
...
C     Amplitude(s) for diagram number 25
      CALL FFV2_5_0(W(1,1),W(1,13),W(1,5),-GC_50,GC_58,AMP(25))
      CALL FFV1_1(W(1,13),W(1,3),GC_11,ZERO, FK_ZERO,W(1,1))
C     Amplitude(s) for diagram number 26
      CALL FFV2_5_0(W(1,9),W(1,1),W(1,5),-GC_50,GC_58,AMP(26))
