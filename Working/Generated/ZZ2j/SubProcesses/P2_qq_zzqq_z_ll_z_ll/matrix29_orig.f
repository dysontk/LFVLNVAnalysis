...
C     
C     Process: d s~ > z z d s~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     Process: s d~ > z z s d~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     Process: d s~ > z z d s~ WEIGHTED<=6 @2
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV2_3_2(W(1,9),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,14),W(1,3),W(1,10),GC_11,AMP(6))
      CALL FFV2_3_1(W(1,3),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 17
      CALL FFV2_3_0(W(1,8),W(1,14),W(1,6),GC_50,GC_58,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV2_3_0(W(1,8),W(1,11),W(1,5),GC_50,GC_58,AMP(18))
