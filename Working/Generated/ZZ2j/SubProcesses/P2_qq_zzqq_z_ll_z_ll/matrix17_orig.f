            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 17 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX17(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.5.3, 2023-12-23
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_17(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_17/ZEROAMP_17
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL OXXXXX(P(0,8),ZERO,NHEL(8),+1*IC(8),W(1,4))
      CALL FFV2_3_2(W(1,1),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,7))
      CALL FFV2_3_2(W(1,2),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,8))
      CALL FFV1P0_3(W(1,7),W(1,3),GC_11,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,8),W(1,4),W(1,9),GC_11,AMP(1))
      CALL FFV1P0_3(W(1,7),W(1,4),GC_11,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,8),W(1,3),W(1,10),GC_11,AMP(2))
      CALL FFV1P0_3(W(1,2),W(1,3),GC_11,ZERO, FK_ZERO,W(1,11))
      CALL FFV2_3_2(W(1,7),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,12),W(1,4),W(1,11),GC_11,AMP(3))
      CALL FFV2_3_1(W(1,4),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,7),W(1,13),W(1,11),GC_11,AMP(4))
      CALL FFV1P0_3(W(1,2),W(1,4),GC_11,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,12),W(1,3),W(1,14),GC_11,AMP(5))
      CALL FFV2_3_1(W(1,3),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,7),W(1,12),W(1,14),GC_11,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,2),W(1,12),W(1,10),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,2),W(1,13),W(1,9),GC_11,AMP(8))
      CALL FFV2_3_2(W(1,1),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
      CALL FFV2_3_2(W(1,2),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,10))
      CALL FFV1P0_3(W(1,9),W(1,3),GC_11,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,10),W(1,4),W(1,7),GC_11,AMP(9))
      CALL FFV1P0_3(W(1,9),W(1,4),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,10),W(1,3),W(1,15),GC_11,AMP(10))
      CALL FFV2_3_2(W(1,9),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,16),W(1,4),W(1,11),GC_11,AMP(11))
      CALL FFV2_3_1(W(1,4),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,9),W(1,17),W(1,11),GC_11,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,16),W(1,3),W(1,14),GC_11,AMP(13))
      CALL FFV2_3_1(W(1,3),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,9),W(1,16),W(1,14),GC_11,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,2),W(1,16),W(1,15),GC_11,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,2),W(1,17),W(1,7),GC_11,AMP(16))
      CALL FFV1P0_3(W(1,1),W(1,3),GC_11,ZERO, FK_ZERO,W(1,7))
      CALL FFV1_1(W(1,4),W(1,7),GC_11,ZERO, FK_ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 20
      ...
      CALL FFV1_2(W(1,2),W(1,7),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 21
      CALL FFV2_3_0(W(1,15),W(1,17),W(1,6),GC_50,GC_58,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV2_3_0(W(1,15),W(1,13),W(1,5),GC_50,GC_58,AMP(22))
      CALL FFV1P0_3(W(1,1),W(1,4),GC_11,ZERO, FK_ZERO,W(1,15))
      CALL FFV1_1(W(1,3),W(1,15),GC_11,ZERO, FK_ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 26
      ...
      CALL FFV1_2(W(1,2),W(1,15),GC_11,ZERO, FK_ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 28
      ...
      CALL FFV1P0_3(W(1,1),W(1,12),GC_11,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,10),W(1,4),W(1,7),GC_11,AMP(29))
      CALL FFV1P0_3(W(1,1),W(1,13),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,10),W(1,3),W(1,15),GC_11,AMP(30))
      CALL FFV1P0_3(W(1,1),W(1,16),GC_11,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,8),W(1,4),W(1,10),GC_11,AMP(31))
      CALL FFV1P0_3(W(1,1),W(1,17),GC_11,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,8),W(1,3),W(1,4),GC_11,AMP(32))
      CALL FFV1_2(W(1,1),W(1,11),GC_11,ZERO, FK_ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 34
      ...
      CALL FFV1_2(W(1,1),W(1,14),GC_11,ZERO, FK_ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 37
      CALL FFV1_0(W(1,2),W(1,13),W(1,10),GC_11,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,2),W(1,16),W(1,15),GC_11,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,2),W(1,12),W(1,4),GC_11,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV1_0(W(1,2),W(1,17),W(1,7),GC_11,AMP(40))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -5.000000000000000D-01)*TMP_JAMP(38)
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX17 = MATRIX17 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_17(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 17, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_17(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 17, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
