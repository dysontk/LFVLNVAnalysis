...
C     
C     Process: u~ u~ > z z u~ u~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: c~ c~ > z z c~ c~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     
      USE DISCRETESAMPLER
            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 32 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX32(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.5.3, 2023-12-23
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_32(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_32/ZEROAMP_32
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_4_3(W(1,3),W(1,4),GC_50,GC_59,MDL_MZ, FK_MDL_WZ,W(1,5))
      CALL IXXXXX(P(0,5),ZERO,NHEL(5),-1*IC(5),W(1,4))
      CALL OXXXXX(P(0,6),ZERO,NHEL(6),+1*IC(6),W(1,3))
      CALL FFV2_4_3(W(1,4),W(1,3),GC_50,GC_59,MDL_MZ, FK_MDL_WZ,W(1,6))
      CALL IXXXXX(P(0,7),ZERO,NHEL(7),-1*IC(7),W(1,3))
      CALL IXXXXX(P(0,8),ZERO,NHEL(8),-1*IC(8),W(1,4))
      CALL FFV2_5_2(W(1,3),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,7))
      CALL FFV2_5_2(W(1,4),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,8))
      CALL FFV1P0_3(W(1,7),W(1,1),GC_11,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,8),W(1,2),W(1,9),GC_11,AMP(1))
      CALL FFV1P0_3(W(1,7),W(1,2),GC_11,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,8),W(1,1),W(1,10),GC_11,AMP(2))
      CALL FFV1P0_3(W(1,4),W(1,1),GC_11,ZERO, FK_ZERO,W(1,11))
      CALL FFV2_5_2(W(1,7),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,12),W(1,2),W(1,11),GC_11,AMP(3))
      CALL FFV2_5_1(W(1,2),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,7),W(1,13),W(1,11),GC_11,AMP(4))
      CALL FFV1P0_3(W(1,4),W(1,2),GC_11,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,12),W(1,1),W(1,14),GC_11,AMP(5))
      CALL FFV2_5_1(W(1,1),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,7),W(1,12),W(1,14),GC_11,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,4),W(1,12),W(1,10),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,4),W(1,13),W(1,9),GC_11,AMP(8))
      CALL FFV2_5_2(W(1,3),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
      CALL FFV2_5_2(W(1,4),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,10))
      CALL FFV1P0_3(W(1,9),W(1,1),GC_11,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,10),W(1,2),W(1,7),GC_11,AMP(9))
      CALL FFV1P0_3(W(1,9),W(1,2),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,10),W(1,1),W(1,15),GC_11,AMP(10))
      CALL FFV2_5_2(W(1,9),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,16),W(1,2),W(1,11),GC_11,AMP(11))
      CALL FFV2_5_1(W(1,2),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,9),W(1,17),W(1,11),GC_11,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,16),W(1,1),W(1,14),GC_11,AMP(13))
      CALL FFV2_5_1(W(1,1),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,9),W(1,16),W(1,14),GC_11,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,4),W(1,16),W(1,15),GC_11,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,4),W(1,17),W(1,7),GC_11,AMP(16))
      CALL FFV1P0_3(W(1,3),W(1,1),GC_11,ZERO, FK_ZERO,W(1,7))
      CALL FFV1_1(W(1,2),W(1,7),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 17
      CALL FFV2_5_0(W(1,10),W(1,15),W(1,6),-GC_50,GC_58,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,10),W(1,13),W(1,7),GC_11,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV2_5_0(W(1,8),W(1,15),W(1,5),-GC_50,GC_58,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,8),W(1,17),W(1,7),GC_11,AMP(20))
      CALL FFV1_2(W(1,4),W(1,7),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 21
      CALL FFV2_5_0(W(1,15),W(1,17),W(1,6),-GC_50,GC_58,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV2_5_0(W(1,15),W(1,13),W(1,5),-GC_50,GC_58,AMP(22))
      CALL FFV1P0_3(W(1,3),W(1,2),GC_11,ZERO, FK_ZERO,W(1,15))
      CALL FFV1_1(W(1,1),W(1,15),GC_11,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 23
      CALL FFV2_5_0(W(1,10),W(1,7),W(1,6),-GC_50,GC_58,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,10),W(1,12),W(1,15),GC_11,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL FFV2_5_0(W(1,8),W(1,7),W(1,5),-GC_50,GC_58,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,8),W(1,16),W(1,15),GC_11,AMP(26))
      CALL FFV1_2(W(1,4),W(1,15),GC_11,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 27
      CALL FFV2_5_0(W(1,7),W(1,16),W(1,6),-GC_50,GC_58,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV2_5_0(W(1,7),W(1,12),W(1,5),-GC_50,GC_58,AMP(28))
      CALL FFV1P0_3(W(1,3),W(1,12),GC_11,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,10),W(1,2),W(1,7),GC_11,AMP(29))
      CALL FFV1P0_3(W(1,3),W(1,13),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,10),W(1,1),W(1,15),GC_11,AMP(30))
      CALL FFV1P0_3(W(1,3),W(1,16),GC_11,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,8),W(1,2),W(1,10),GC_11,AMP(31))
      CALL FFV1P0_3(W(1,3),W(1,17),GC_11,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,8),W(1,1),W(1,2),GC_11,AMP(32))
      CALL FFV1_2(W(1,3),W(1,11),GC_11,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 33
      CALL FFV2_5_0(W(1,8),W(1,17),W(1,6),-GC_50,GC_58,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFV2_5_0(W(1,8),W(1,13),W(1,5),-GC_50,GC_58,AMP(34))
      CALL FFV1_2(W(1,3),W(1,14),GC_11,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 35
      CALL FFV2_5_0(W(1,8),W(1,16),W(1,6),-GC_50,GC_58,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL FFV2_5_0(W(1,8),W(1,12),W(1,5),-GC_50,GC_58,AMP(36))
C     Amplitude(s) for diagram number 37
      CALL FFV1_0(W(1,4),W(1,13),W(1,10),GC_11,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,4),W(1,16),W(1,15),GC_11,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,4),W(1,12),W(1,2),GC_11,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV1_0(W(1,4),W(1,17),W(1,7),GC_11,AMP(40))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      TMP_JAMP(30) = TMP_JAMP(20) +  TMP_JAMP(17)  ! used 2 times
      TMP_JAMP(29) = TMP_JAMP(19) +  TMP_JAMP(18)  ! used 2 times
      TMP_JAMP(28) = TMP_JAMP(16) +  TMP_JAMP(14)  ! used 2 times
      TMP_JAMP(27) = TMP_JAMP(15) +  TMP_JAMP(11)  ! used 2 times
      TMP_JAMP(26) = TMP_JAMP(13) +  TMP_JAMP(12)  ! used 2 times
      TMP_JAMP(25) = TMP_JAMP(10) +  TMP_JAMP(9)  ! used 2 times
      TMP_JAMP(24) = TMP_JAMP(8) +  TMP_JAMP(5)  ! used 2 times
      TMP_JAMP(23) = TMP_JAMP(7) +  TMP_JAMP(6)  ! used 2 times
      TMP_JAMP(22) = TMP_JAMP(4) +  TMP_JAMP(1)  ! used 2 times
      TMP_JAMP(21) = TMP_JAMP(3) +  TMP_JAMP(2)  ! used 2 times
      TMP_JAMP(34) = TMP_JAMP(28) +  TMP_JAMP(26)  ! used 2 times
      TMP_JAMP(33) = TMP_JAMP(27) +  TMP_JAMP(25)  ! used 2 times
      TMP_JAMP(32) = TMP_JAMP(24) +  TMP_JAMP(22)  ! used 2 times
      TMP_JAMP(31) = TMP_JAMP(23) +  TMP_JAMP(21)  ! used 2 times
      TMP_JAMP(36) = TMP_JAMP(32) +  TMP_JAMP(29)  ! used 2 times
      TMP_JAMP(35) = TMP_JAMP(31) +  TMP_JAMP(30)  ! used 2 times
      TMP_JAMP(38) = TMP_JAMP(36) +  TMP_JAMP(33)  ! used 2 times
      TMP_JAMP(37) = TMP_JAMP(35) +  TMP_JAMP(34)  ! used 2 times
      JAMP(1,1) = (5.000000000000000D-01)*TMP_JAMP(37)
     $ +(1.666666666666667D-01)*TMP_JAMP(38)
      JAMP(2,1) = (-1.666666666666667D-01)*TMP_JAMP(37)+(
     $ -5.000000000000000D-01)*TMP_JAMP(38)

      IF(INIT_MODE)THEN
        DO I=1, NGRAPHS
          IF (AMP(I).NE.0) THEN
            ZEROAMP_32(IHEL,I) = .FALSE.
          ENDIF
        ENDDO
      ENDIF
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX32 = MATRIX32 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_32(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 32, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_32(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 32, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX32(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS32/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS32
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX32=SOINDEX_FOR_SQUARED_ORDERS32(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS32(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS32/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS32 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS32'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN32(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX32(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX32'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX32(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS32(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS32 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS32'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
