            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 26 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX26(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.5.3, 2023-12-23
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_26(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_26/ZEROAMP_26
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV1P0_3(W(1,7),W(1,2),GC_11,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,8),W(1,3),W(1,9),GC_11,AMP(1))
      CALL FFV1P0_3(W(1,7),W(1,3),GC_11,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,8),W(1,2),W(1,10),GC_11,AMP(2))
      CALL FFV1P0_3(W(1,4),W(1,2),GC_11,ZERO, FK_ZERO,W(1,11))
      CALL FFV2_3_2(W(1,7),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,12),W(1,3),W(1,11),GC_11,AMP(3))
      CALL FFV2_3_1(W(1,3),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,7),W(1,13),W(1,11),GC_11,AMP(4))
      CALL FFV1P0_3(W(1,4),W(1,3),GC_11,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,12),W(1,2),W(1,14),GC_11,AMP(5))
      CALL FFV2_3_1(W(1,2),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1P0_3(W(1,9),W(1,2),GC_11,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,10),W(1,3),W(1,7),GC_11,AMP(9))
      CALL FFV1P0_3(W(1,9),W(1,3),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,10),W(1,2),W(1,15),GC_11,AMP(10))
      CALL FFV2_3_2(W(1,9),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,16),W(1,3),W(1,11),GC_11,AMP(11))
      CALL FFV2_3_1(W(1,3),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,9),W(1,17),W(1,11),GC_11,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,16),W(1,2),W(1,14),GC_11,AMP(13))
      CALL FFV2_3_1(W(1,2),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 16
      ...
      CALL FFV1P0_3(W(1,1),W(1,2),GC_11,ZERO, FK_ZERO,W(1,7))
      CALL FFV1_1(W(1,3),W(1,7),GC_11,ZERO, FK_ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 22
      ...
      CALL FFV1P0_3(W(1,1),W(1,3),GC_11,ZERO, FK_ZERO,W(1,15))
      CALL FFV1_1(W(1,2),W(1,15),GC_11,ZERO, FK_ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,10),W(1,3),W(1,7),GC_11,AMP(29))
      CALL FFV1P0_3(W(1,1),W(1,13),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,10),W(1,2),W(1,15),GC_11,AMP(30))
      CALL FFV1P0_3(W(1,1),W(1,16),GC_11,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,8),W(1,3),W(1,10),GC_11,AMP(31))
      CALL FFV1P0_3(W(1,1),W(1,17),GC_11,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,8),W(1,2),W(1,3),GC_11,AMP(32))
...
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,4),W(1,12),W(1,3),GC_11,AMP(39))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -5.000000000000000D-01)*TMP_JAMP(38)
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX26 = MATRIX26 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_26(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 26, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_26(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 26, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX26(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS26/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS26
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX26=SOINDEX_FOR_SQUARED_ORDERS26(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS26(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS26/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS26 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS26'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN26(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX26(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX26'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX26(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS26(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS26 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS26'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
