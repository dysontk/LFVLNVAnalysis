...
C     
C     Process: d~ d~ > z z d~ d~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: s~ s~ > z z s~ s~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     
      USE DISCRETESAMPLER
            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 38 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX38(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.5.3, 2023-12-23
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_38(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_38/ZEROAMP_38
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3_2(W(1,3),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,7))
      CALL FFV2_3_2(W(1,4),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_3_2(W(1,7),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,12),W(1,2),W(1,11),GC_11,AMP(3))
      CALL FFV2_3_1(W(1,2),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV2_3_1(W(1,1),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV2_3_2(W(1,3),W(1,6),GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
      CALL FFV2_3_2(W(1,4),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV2_3_2(W(1,9),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,16),W(1,2),W(1,11),GC_11,AMP(11))
      CALL FFV2_3_1(W(1,2),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,9),W(1,17),W(1,11),GC_11,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,16),W(1,1),W(1,14),GC_11,AMP(13))
      CALL FFV2_3_1(W(1,1),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 27
      CALL FFV2_3_0(W(1,7),W(1,16),W(1,6),GC_50,GC_58,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV2_3_0(W(1,7),W(1,12),W(1,5),GC_50,GC_58,AMP(28))
...
C     Amplitude(s) for diagram number 33
      CALL FFV2_3_0(W(1,8),W(1,17),W(1,6),GC_50,GC_58,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFV2_3_0(W(1,8),W(1,13),W(1,5),GC_50,GC_58,AMP(34))
      CALL FFV1_2(W(1,3),W(1,14),GC_11,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 35
      CALL FFV2_3_0(W(1,8),W(1,16),W(1,6),GC_50,GC_58,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL FFV2_3_0(W(1,8),W(1,12),W(1,5),GC_50,GC_58,AMP(36))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -5.000000000000000D-01)*TMP_JAMP(38)
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX38 = MATRIX38 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_38(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 38, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_38(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 38, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX38(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS38/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS38
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX38=SOINDEX_FOR_SQUARED_ORDERS38(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS38(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS38/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS38 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS38'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN38(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX38(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX38'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX38(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS38(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS38 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS38'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
