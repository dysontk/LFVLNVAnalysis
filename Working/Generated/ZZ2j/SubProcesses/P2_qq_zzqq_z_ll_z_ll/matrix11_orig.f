...
C     
C     Process: u u~ > z z d d~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     Process: u u~ > z z s s~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     Process: c c~ > z z d d~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     Process: c c~ > z z s s~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     Process: u u~ > z z d d~ WEIGHTED<=6 @2
...
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,4),W(1,9),W(1,2),GC_11,AMP(20))
