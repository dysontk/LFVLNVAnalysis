...
C     
C     Process: u u~ > z z c c~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     Process: c c~ > z z u u~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     Process: u u~ > z z c c~ WEIGHTED<=6 @2
            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 9 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX9(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.5.3, 2023-12-23
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_9(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_9/ZEROAMP_9
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV2_5_1(W(1,3),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 9
      CALL FFV2_5_0(W(1,12),W(1,2),W(1,6),-GC_50,GC_58,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,12),W(1,7),W(1,13),GC_11,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_5_0(W(1,8),W(1,2),W(1,5),-GC_50,GC_58,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,8),W(1,9),W(1,13),GC_11,AMP(12))
      CALL FFV1_2(W(1,4),W(1,13),GC_11,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 13
      CALL FFV2_5_0(W(1,2),W(1,9),W(1,6),-GC_50,GC_58,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_5_0(W(1,2),W(1,7),W(1,5),-GC_50,GC_58,AMP(14))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX9 = MATRIX9 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_9(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 9, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_9(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 9, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
