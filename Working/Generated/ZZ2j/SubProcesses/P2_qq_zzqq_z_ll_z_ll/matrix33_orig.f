            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 33 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX33(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.5.3, 2023-12-23
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_33(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_33/ZEROAMP_33
...
C     Amplitude(s) for diagram number 9
      CALL FFV2_5_0(W(1,12),W(1,1),W(1,6),-GC_50,GC_58,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,12),W(1,7),W(1,13),GC_11,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_5_0(W(1,8),W(1,1),W(1,5),-GC_50,GC_58,AMP(11))
...
C     Amplitude(s) for diagram number 14
      CALL FFV2_5_0(W(1,1),W(1,7),W(1,5),-GC_50,GC_58,AMP(14))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX33 = MATRIX33 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_33(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 33, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_33(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 33, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
