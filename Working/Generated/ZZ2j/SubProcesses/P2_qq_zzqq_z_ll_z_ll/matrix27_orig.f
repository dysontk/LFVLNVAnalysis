...
C     
C     Process: d d~ > z z s s~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     Process: s s~ > z z d d~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     Process: d d~ > z z s s~ WEIGHTED<=6 @2
            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 27 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX27(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.5.3, 2023-12-23
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_27(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_27/ZEROAMP_27
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV2_3_1(W(1,2),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,14))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX27 = MATRIX27 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_27(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 27, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_27(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 27, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
