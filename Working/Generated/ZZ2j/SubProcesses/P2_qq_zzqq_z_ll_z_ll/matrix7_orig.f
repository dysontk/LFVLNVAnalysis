            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 7 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX7(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 3.5.3, 2023-12-23
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_7(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_7/ZEROAMP_7
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_5_2(W(1,1),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_5_1(W(1,3),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV2_5_1(W(1,2),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV2_5_2(W(1,1),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 11
      ...
      CALL FFV2_5_1(W(1,3),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,9),W(1,17),W(1,11),GC_11,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,16),W(1,2),W(1,14),GC_11,AMP(13))
      CALL FFV2_5_1(W(1,2),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,16))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -5.000000000000000D-01)*TMP_JAMP(38)
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX7 = MATRIX7 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_7(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 7, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_7(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 7, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
