...
C     
C     Process: d u~ > z z d u~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: d c~ > z z d c~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: s u~ > z z s u~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: s c~ > z z s c~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     
      USE DISCRETESAMPLER
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_5_2(W(1,4),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1P0_3(W(1,1),W(1,3),GC_11,ZERO, FK_ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,1),W(1,7),W(1,9),GC_11,AMP(4))
      CALL FFV2_5_2(W(1,4),W(1,6),-GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
      CALL FFV2_3_2(W(1,1),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,12))
      CALL FFV1P0_3(W(1,9),W(1,2),GC_11,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,12),W(1,3),W(1,13),GC_11,AMP(5))
      CALL FFV2_5_2(W(1,9),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,14),W(1,2),W(1,10),GC_11,AMP(6))
      CALL FFV2_5_1(W(1,2),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,9),W(1,14),W(1,10),GC_11,AMP(7))
      CALL FFV2_3_1(W(1,3),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,1),W(1,9),W(1,13),GC_11,AMP(8))
      CALL FFV1P0_3(W(1,4),W(1,2),GC_11,ZERO, FK_ZERO,W(1,13))
      CALL FFV1_1(W(1,3),W(1,13),GC_11,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 9
      CALL FFV2_3_0(W(1,12),W(1,2),W(1,6),GC_50,GC_58,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,12),W(1,7),W(1,13),GC_11,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_3_0(W(1,8),W(1,2),W(1,5),GC_50,GC_58,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,8),W(1,9),W(1,13),GC_11,AMP(12))
      CALL FFV1_2(W(1,1),W(1,13),GC_11,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 13
      CALL FFV2_3_0(W(1,2),W(1,9),W(1,6),GC_50,GC_58,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_3_0(W(1,2),W(1,7),W(1,5),GC_50,GC_58,AMP(14))
      CALL FFV1P0_3(W(1,4),W(1,11),GC_11,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,12),W(1,3),W(1,2),GC_11,AMP(15))
      CALL FFV1P0_3(W(1,4),W(1,14),GC_11,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,8),W(1,3),W(1,12),GC_11,AMP(16))
      CALL FFV1_2(W(1,4),W(1,10),GC_11,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 17
      CALL FFV2_5_0(W(1,8),W(1,14),W(1,6),-GC_50,GC_58,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV2_5_0(W(1,8),W(1,11),W(1,5),-GC_50,GC_58,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,1),W(1,7),W(1,12),GC_11,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,1),W(1,9),W(1,2),GC_11,AMP(20))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      TMP_JAMP(15) = TMP_JAMP(10) +  TMP_JAMP(9)  ! used 2 times
      TMP_JAMP(14) = TMP_JAMP(8) +  TMP_JAMP(7)  ! used 2 times
      TMP_JAMP(13) = TMP_JAMP(6) +  TMP_JAMP(5)  ! used 2 times
      TMP_JAMP(12) = TMP_JAMP(4) +  TMP_JAMP(3)  ! used 2 times
      TMP_JAMP(11) = TMP_JAMP(2) +  TMP_JAMP(1)  ! used 2 times
      TMP_JAMP(17) = TMP_JAMP(14) +  TMP_JAMP(13)  ! used 2 times
      TMP_JAMP(16) = TMP_JAMP(12) +  TMP_JAMP(11)  ! used 2 times
      TMP_JAMP(18) = TMP_JAMP(16) +  TMP_JAMP(15)  ! used 2 times
      TMP_JAMP(19) = TMP_JAMP(18) +  TMP_JAMP(17)  ! used 2 times
      JAMP(1,1) = (5.000000000000000D-01)*TMP_JAMP(19)
      JAMP(2,1) = (-1.666666666666667D-01)*TMP_JAMP(19)
