...
C     
C     Process: g g > z z u u~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     Process: g g > z z c c~ WEIGHTED<=6 @2
C     *   Decay: z > e+ e- WEIGHTED<=2
C     *   Decay: z > mu+ mu- WEIGHTED<=2
C     
      USE DISCRETESAMPLER
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_5_1(W(1,3),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV2_5_2(W(1,7),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 13
      CALL FFV2_5_0(W(1,3),W(1,4),W(1,6),-GC_50,GC_58,AMP(13))
